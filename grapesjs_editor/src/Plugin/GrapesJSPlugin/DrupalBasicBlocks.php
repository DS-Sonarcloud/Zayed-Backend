...
class DrupalBasicBlocks extends GrapesJSPluginBase implements GrapesJSPluginConfigurableInterface
{
  ...
  public function getConfig(Editor $editor)
  {
    ...
    // Default to all blocks if no specific configuration is found (or if all were filtered out)
    $enabled_block_keys = !empty($blocks) ? array_keys($blocks) : array_keys($this->blocks);
