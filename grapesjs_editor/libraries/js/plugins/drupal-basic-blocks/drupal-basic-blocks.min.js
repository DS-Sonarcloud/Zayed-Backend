/**
 * @file
 * Contains drupal-basic-blocks.js (Manually Bundled IIFE)
 */
(function(window, $, Drupal) {
  ...
  const loadComponents = (editor, opts = {}) => {
    ...
    // For now, it mostly adds blocks that insert standard HTML traits.
  };
  ...
  const loadBlocks = (editor, opts = {}) => {
    ...
    // ... Add more basic blocks as defined in the original file if needed
    // For now, this covers the requested "Reusable" functional equivalents (Standard HTML)
    
    // Add any specific "Reusable" blocks passed via config
     if (opts.blocks) {
        opts.blocks.forEach((block) => {
             // Logic to add custom blocks if they were passed
             // blockManager.add(...)
        });
     }
  };
