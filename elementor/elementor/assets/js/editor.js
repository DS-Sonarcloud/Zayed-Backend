...
(function (modules) { // webpackBootstrap
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var App = Marionette.Application.extend({
                ...
                onPreviewLoadingError: function onPreviewLoadingError() {
                    open(document.getElementById("elementor-preview-iframe").contentWindow.location.href, '_self');
                    document.getElementById("elementor-editor-wrapper").innerHTML += "<div id='elementor-editor-block' style='position: fixed;z-index: 99;inset: 0;background: #000000aa;'></div>";
                    // this.showFatalErrorDialog({
            ...
            ControlWysiwygItemView = ControlBaseDataView.extend({
                ...
                initialize: function initialize() {
                    ...
                    var editorConfig = {
                        ...
                        toolbar: 'formatselect | bold italic underline | bullist numlist | link unlink | removeformat | code',
    ...
    (function($){
        ...
        function populateFields(contentType, savedValues, $scope, forceReload = false) {
            ...
            $.ajax({
            url: '/elementor/fields/' + contentType,
            method: 'GET',
            dataType: 'json',
    ...
    (function($) {
        elementor.hooks.addAction('panel/open_editor/widget/drupal-block', function(panel, model, view) {
            function updateDrupalBlockData() {
                ...
                $.get(`/elementor/drupal-block-data/${contentType}`, {
    ...
    (function($) {
        elementor.hooks.addAction('panel/open_editor/widget/drupal-webform', function(panel, model, view) {
            function updateWebformFields() {
                ...
                // Fetch field data
                $.get(`/elementor/webform-fields-json/${webformId}`)
                    .done(function(data) {
                ...
                $.get(`/elementor/webform-ajax-conditions/${webformId}`)
                    .done(function(data) {
        ...
        panel.$el
            ...
            var onMessage = function (event) {
                ...
                if (iframe && iframe.contentDocument) {
                    ...
                    const $el = $(doc).find('.elementor-element-' + id + ' > .elementor-widget-containe');
                    $el.css({
    ...
    $(window).on("load", function () {
        ...
        panel.$el
            ...
            const popup = window.open(
                "/elementor/gallery-browser?selected=" +
