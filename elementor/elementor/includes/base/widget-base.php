...
?>
		<div class="elementor-widget-container">
			...
			?><script type="text/template" id="tmpl-elementor-advanced-css-{{{ view.getID() }}}">
			<# 
			if ( settings.advanced_css ) {
				...
				css = css.replace(/selector/g, '.elementor-element-' + view.getID());
	...
	?>
		<div class="elementor-widget-container">
			...
			if (!empty($settings['advanced_css'])) {
				...
				$custom_css = str_replace('selector', '.elementor-element-' . $this->get_id(), $custom_css);
