...
class Element_Column extends Element_Base {
	...
	public function get_title() {
		return ___elementor_adapter( 'Column', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'_inline_size',
			[
				'label' => ___elementor_adapter( 'Column Width', 'elementor' ) . ' (%)',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'center' => ___elementor_adapter( 'Middle', 'elementor' ),
    ...
    $this->add_control(
      'marquee_behavior',
      [
        'label' => ___elementor_adapter('Marquee Behavior', 'elementor'),
        'type' => Controls_Manager::SELECT,
        'default' => 'scroll',
        'options' => [
          'scroll' => 'Scroll',
    ...
    $this->add_control(
      'marquee_direction',
      [
        'label' => ___elementor_adapter('Marquee Direction', 'elementor'),
        'type' => Controls_Manager::SELECT,
        'default' => 'left',
        'options' => [
          'left' => 'Left',
    ...
    $this->add_control(
      'marquee_speed',
      [
        'label' => ___elementor_adapter('Scroll Speed', 'elementor'),
        'type' => Controls_Manager::NUMBER,
        'min' => 1,
        'max' => 20,
        'default' => 5,
    ...
    if ( 'marquee' === $settings['html_tag'] ) {
      $this->add_render_attribute( '_wrapper', 'class', 'elementor-marquee' );
