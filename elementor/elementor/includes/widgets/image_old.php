...
class Widget_Image extends Widget_Base
{
  use StringTranslationTrait;
	...
	{
		return ___elementor_adapter('Image', 'elementor');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'placeholder' => ___elementor_adapter('Enter your image caption', 'elementor'),
			]
		);
		...
		$this->add_responsive_control(
			'space',
			[
				'label' => ___elementor_adapter('Max Width', 'elementor') . ' (%)',
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => ___elementor_adapter('Hover Animation', 'elementor'),
	...
	protected function render()
	{
		...
		//$media_id = $this->get_settings_for_display('drupal_media');
		$settings['image']['asa'] = "dfsdf";
		// print_r($settings);
		...
		$settings['image_hover_animation'] = ! empty($settings['hover_animation']) ? 'elementor-animation-' . $settings['hover_animation'] : '';
		if ($link) {
