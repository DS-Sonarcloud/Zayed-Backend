  ...
  /**
    ...
    $document->start_injection( [
		...
		$document->add_control(
			'deploy',
			[
				'label' => ___elementor_adapter( 'Deploy Page', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
        'default' => 'yes', // ✅ This makes "Yes" selected by default
				'description' => sprintf(
					/* translators: %s: Setting page link */
					___elementor_adapter( 'By enabling this option this page will be exported as json and will be deployed to frontend.', 'elementor' ),
					Settings::get_url() . '#tab-style'
				),
				'selectors' => [
