...
abstract class Base {
	...
	public static function get_base_uploads_dir() {
		...
		if ( is_array( $wp_upload_dir ) && isset( $wp_upload_dir['basedir'] ) ) {
	...
	public function get_url() {
		...
		return add_query_arg_layoutbridge_adapter( [ 'ver' => $this->get_meta( 'time' ) ], $url );
	}
	...
	protected function load_meta() {
		return get_option_layoutbridge_adapter( static::META_KEY );
	}
	...
	protected function update_meta( $meta ) {
		update_option_layoutbridge_adapter( static::META_KEY, $meta );
	}
	...
	private static function get_wp_uploads_dir() {
		if ( ! self::$wp_uploads_dir ) {
			self::$wp_uploads_dir = wp_upload_dir_layoutbridge_adapter( null, false );
		}
	...
	private function set_path() {
		...
		if ( ! is_dir( $dir_path ) ) {
			wp_mkdir_p_layoutbridge_adapter( $dir_path );
		}
