...
class Post extends Base {
	...
	public function get_element_unique_selector( Element_Base $element ) {
		return '.drupal_layoutbuilder-' . $this->post_id . ' .drupal_layoutbuilder-element' . $element->get_unique_selector();
	}
	...
	protected function load_meta() {
		return get_post_meta_layoutbridge_adapter( $this->post_id, static::META_KEY, true );
	}
	...
	protected function update_meta( $meta ) {
		update_post_meta_layoutbridge_adapter( $this->post_id, static::META_KEY, $meta );
	}
	...
	protected function delete_meta() {
		delete_post_meta_layoutbridge_adapter( $this->post_id, static::META_KEY );
	}
	...
	protected function get_enqueue_dependencies() {
		return [ 'drupal_layoutbuilder-frontend' ];
	}
	...
	protected function get_file_handle_id() {
		return 'drupal_layoutbuilder-post-' . $this->post_id;
	}
	...
	protected function render_styles( Element_Base $element ) {
		 ...
		 * @param Element_Base $element The element.
		 */
		do_action_layoutbridge_adapter( 'elementor/element/before_parse_css', $this, $element );
		 ...
		 * @param Element_Base $element The element.
		 */
		do_action_layoutbridge_adapter( 'elementor/element/parse_css', $this, $element );
	}
}
