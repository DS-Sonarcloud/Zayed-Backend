...
class Manager {
	...
	public function clear_cache() {
		...
		delete_option_layoutbridge_adapter( Global_CSS::META_KEY );

		delete_option_layoutbridge_adapter( Frontend::META_KEY );
		 ...
		 * @since 2.1.0
		 */
		do_action_layoutbridge_adapter( 'elementor/core/files/clear_cache' );
	}
	...
	private function register_actions() {
		add_action_layoutbridge_adapter( 'deleted_post', [ $this, 'on_delete_post' ] );
		add_filter_layoutbridge_adapter( 'wxr_export_skip_postmeta', [ $this, 'on_export_post_meta' ], 10, 2 );
	}
}
