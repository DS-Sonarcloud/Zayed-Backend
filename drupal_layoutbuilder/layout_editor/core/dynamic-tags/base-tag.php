...
abstract class Base_Tag extends Controls_Stack {
	...
	public function print_panel_template() {
		...
		?><#
		var key = <?php echo esc_html_layoutbridge_adapter( $panel_template_setting_key ); ?>;

		if ( key ) {
			var settingsKey = "<?php echo esc_html_layoutbridge_adapter( $panel_template_setting_key ); ?>";
	...
	final protected function init_controls() {
		...
		$this->start_controls_section( 'settings', [
			'label' => ___layoutbridge_adapter( 'Settings', 'elementor' ),
		] );
