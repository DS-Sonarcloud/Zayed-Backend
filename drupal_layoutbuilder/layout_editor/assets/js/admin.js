	...
	var ElementorAdmin = ViewModule.extend({
		...
		getDefaultElements: function getDefaultElements() {
			var elements = {
				$window: $(window),
				$body: $('body'),
				$switchMode: $('#drupal_layoutbuilder-switch-mode'),
				$goToEditLink: $('#drupal_layoutbuilder-go-to-edit-page-link'),
				$switchModeInput: $('#drupal_layoutbuilder-switch-mode-input'),
				$switchModeButton: $('#drupal_layoutbuilder-switch-mode-button'),
				$elementorLoader: $('.drupal_layoutbuilder-loader'),
				$builderEditor: $('#drupal_layoutbuilder-editor'),
				$importButton: $('#drupal_layoutbuilder-import-template-trigger'),
				$importArea: $('#drupal_layoutbuilder-import-template-area'),
				$settingsForm: $('#drupal_layoutbuilder-settings-form'),
				$settingsTabsWrapper: $('#drupal_layoutbuilder-settings-tabs-wrapper')
			};

			elements.$settingsFormPages = elements.$settingsForm.find('.drupal_layoutbuilder-settings-form-page');

			elements.$activeSettingsPage = elements.$settingsFormPages.filter('.drupal_layoutbuilder-active');
		...
		toggleStatus: function toggleStatus() {
			...
			this.elements.$body.toggleClass('drupal_layoutbuilder-editor-active', isElementorMode).toggleClass('drupal_layoutbuilder-editor-inactive', !isElementorMode);
		},
		...
		bindEvents: function bindEvents() {
			...
			$('div.notice.drupal_layoutbuilder-message-dismissed').on('click', 'button.notice-dismiss, .drupal_layoutbuilder-button-notice-dismiss', function (event) {
				event.preventDefault();

				$.post(ajaxurl, {
					action: 'elementor_set_admin_notice_viewed',
					notice_id: $(this).closest('.drupal_layoutbuilder-message-dismissed').data('notice_id')
				});

				var $wrapperElm = $(this).closest('.drupal_layoutbuilder-message-dismissed');
			...
			$('#drupal_layoutbuilder-clear-cache-button').on('click', function (event) {
				event.preventDefault();
				var $thisButton = $(this);
			...
			$('#drupal_layoutbuilder-library-sync-button').on('click', function (event) {
				event.preventDefault();
				var $thisButton = $(this);
			...
			$('#drupal_layoutbuilder-replace-url-button').on('click', function (event) {
				event.preventDefault();
				var $this = $(this),
				    $tr = $this.parents('tr'),
			...
			$('.drupal_layoutbuilder-rollback-button').on('click', function (event) {
				event.preventDefault();
			...
			$('.elementor_css_print_method select').on('change', function () {
				var $descriptions = $('.drupal_layoutbuilder-css-print-method-description');
		...
		initTemplatesImport: function initTemplatesImport() {
			...
			$importButton.on('click', function () {
				$('#drupal_layoutbuilder-import-template-area').toggle();
			});
		},
		...
		animateLoader: function animateLoader() {
			this.elements.$goToEditLink.addClass('drupal_layoutbuilder-animate');
		},
		...
		goToSettingsTab: function goToSettingsTab(tabName) {
			...
			this.elements.$activeSettingsPage.removeClass('drupal_layoutbuilder-active');

			this.elements.$activeSettingsTab.removeClass('nav-tab-active');

			var $activeTab = this.elements.$settingsTabs.filter('#drupal_layoutbuilder-settings-' + tabName);

			$activePage.addClass('drupal_layoutbuilder-active');
		...
		roleManager: {
			selectors: {
				body: 'drupal_layoutbuilder-role-manager',
				row: '.drupal_layoutbuilder-role-row',
				label: '.drupal_layoutbuilder-role-label',
				excludedIndicator: '.drupal_layoutbuilder-role-excluded-indicator',
				excludedField: 'input[name="elementor_exclude_user_roles[]"]',
				controlsContainer: '.drupal_layoutbuilder-role-controls',
				toggleHandle: '.drupal_layoutbuilder-role-toggle',
	...
	getDefaultSettings: function getDefaultSettings() {
		return {
			selectors: {
				...
				maintenanceModeDescriptions: '.drupal_layoutbuilder-maintenance-mode-description',
				...
				editTemplateButton: '.drupal_layoutbuilder-edit-template',
				maintenanceModeError: '.drupal_layoutbuilder-maintenance-mode-error'
			},
			classes: {
				isEnabled: 'drupal_layoutbuilder-maintenance-mode-is-enabled'
			}
		};
	},
