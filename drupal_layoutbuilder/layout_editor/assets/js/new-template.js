...
var NewTemplateModule = ViewModule.extend({
	...
	getDefaultSettings: function getDefaultSettings() {
		return {
			selectors: {
				addButton: '.page-title-action:first, #drupal_layoutbuilder-template-library-add-new'
			}
		};
	},
...
module.exports = BaseModalLayout.extend({
	...
	getModalOptions: function getModalOptions() {
		return {
			id: 'drupal_layoutbuilder-new-template-modal'
		};
	},
...
module.exports = Marionette.ItemView.extend({
	...
	id: 'drupal_layoutbuilder-new-template-dialog-content',

	template: '#tmpl-drupal_layoutbuilder-new-template',
