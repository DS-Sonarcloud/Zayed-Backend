...
(function ($) {
	...
	var ElementorGutenbergApp = {
		...
		cacheElements: function cacheElements() {
			...
			this.cache.$switchMode = $($('#drupal_layoutbuilder-gutenberg-button-switch-mode').html());

			this.cache.$gutenberg.find('.edit-post-header-toolbar').append(this.cache.$switchMode);
			this.cache.$switchModeButton = this.cache.$switchMode.find('#drupal_layoutbuilder-switch-mode-button');
		...
		buildPanel: function buildPanel() {
			...
			if (!$('#drupal_layoutbuilder-editor').length) {
				self.cache.$editorPanel = $($('#drupal_layoutbuilder-gutenberg-panel').html());
				...
				self.cache.$editorPanelButton = self.cache.$editorPanel.find('#drupal_layoutbuilder-go-to-edit-page-link');
		...
		animateLoader: function animateLoader() {
			this.cache.$editorPanelButton.addClass('drupal_layoutbuilder-animate');
		},

		toggleStatus: function toggleStatus() {
			jQuery('body').toggleClass('drupal_layoutbuilder-editor-active', this.isElementorMode).toggleClass('drupal_layoutbuilder-editor-inactive', !this.isElementorMode);
		},
