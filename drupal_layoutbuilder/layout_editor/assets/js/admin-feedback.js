	...
	var ElementorAdminDialogApp = {
		...
		cacheElements: function cacheElements() {
			this.cache = {
				...
				$dialogHeader: $('#drupal_layoutbuilder-deactivate-feedback-dialog-header'),
				$dialogForm: $('#drupal_layoutbuilder-deactivate-feedback-dialog-form')
			};
		},
			...
			self.getModal = function () {
				if (!modal) {
					modal = elementorAdmin.getDialogsManager().createWidget('lightbox', {
						id: 'drupal_layoutbuilder-deactivate-feedback-modal',
						...
						onShow: function onShow() {
							var $dialogModal = $('#drupal_layoutbuilder-deactivate-feedback-modal'),
							    radioSelector = '.drupal_layoutbuilder-deactivate-feedback-dialog-input';
		...
		sendFeedback: function sendFeedback() {
			...
			self.getModal().getElements('submit').text('').addClass('drupal_layoutbuilder-loading');
