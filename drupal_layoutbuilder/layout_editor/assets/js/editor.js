...
(function (modules) { // webpackBootstrap
    ...
    ([
            ...
            ControlBaseDataView = ControlBaseView.extend({
                ...
                ui: function ui() {
                    ...
                    _.extend(ui, {
                        ...
                        responsiveSwitchers: '.drupal_layoutbuilder-responsive-switcher',
                ...
                renderResponsiveSwitchers: function renderResponsiveSwitchers() {
                    var templateHtml = Marionette.Renderer.render('#tmpl-drupal_layoutbuilder-control-responsive-switchers', this.model.attributes);
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Module = function Module() {
                ...
                this.on = function (eventName, callback) {
                    if ('object' === (typeof eventName === 'undefined' ? 'undefined' : _typeof(eventName)) && null !== eventName) {
                        // Arrays: register the same callback for each event name.
                        if (Array.isArray(eventName)) {
                            eventName.forEach(function (singleEventName) {
                                self.on(singleEventName, callback);
                            });

                            return self;
                        }

                        // PHP json_encode of a list often becomes { "0": "…", "1": "…" } in JS (not Array).
                        // Treat as a list of event names only when every entry is a string and a callback exists.
                        var mapKeys = Object.keys(eventName),
                            isDenseZeroBased = mapKeys.length > 0 && mapKeys.every(function (k) {
                                return /^\d+$/.test(k);
                            });

                        if (isDenseZeroBased) {
                            var numericKeys = mapKeys.map(function (k) {
                                return parseInt(k, 10);
                            }).sort(function (a, b) {
                                return a - b;
                            }),
                                maxIdx = numericKeys[numericKeys.length - 1];

                            isDenseZeroBased = numericKeys[0] === 0 && numericKeys.length === maxIdx + 1;

                            for (var d = 0; isDenseZeroBased && d < numericKeys.length; d++) {
                                if (numericKeys[d] !== d) {
                                    isDenseZeroBased = false;
                                }
                            }
                        }

                        if (isDenseZeroBased) {
                            var ordered = numericKeys.map(function (i) {
                                return eventName[i] !== undefined ? eventName[i] : eventName[String(i)];
                            });

                            if (ordered.every(function (v) {
                        ...
                        $.each(eventName, function (key, value) {
                            var handler = value;

                            if ('string' === typeof handler) {
                                if ('function' === typeof self[handler]) {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlBaseView = Marionette.CompositeView.extend({
                ui: function ui() {
                    return {
                        controlTitle: '.drupal_layoutbuilder-control-title'
                    };
                },
                ...
                className: function className() {
                    ...
                    var classes = 'drupal_layoutbuilder-control drupal_layoutbuilder-control-' + this.model.get('name') + ' drupal_layoutbuilder-control-type-' + this.model.get('type'),
                    ...
                    if (!_.isEmpty(responsive)) {
                        classes += ' drupal_layoutbuilder-control-responsive-' + responsive.max;
                    }
                ...
                getTemplate: function getTemplate() {
                    return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-control-' + this.model.get('type') + '-content');
                },
                ...
                toggleControlVisibility: function toggleControlVisibility() {
                    ...
                    this.$el.toggleClass('drupal_layoutbuilder-hidden-control', !isVisible);
                ...
                onRender: function onRender() {
                    var layoutType = this.model.get('label_block') ? 'block' : 'inline',
                        ...
                        elClasses = 'drupal_layoutbuilder-label-' + layoutType;

                    elClasses += ' drupal_layoutbuilder-control-separator-' + this.model.get('separator');

                    if (!showLabel) {
                        elClasses += ' drupal_layoutbuilder-control-hidden-label';
                    }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.LayoutView.extend({
                ...
                initModal: function initModal() {
                    var modalOptions = {
                        className: 'drupal_layoutbuilder-templates-modal',
                        closeButton: false,
                        hide: {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-templates-modal__header__logo',

                className: 'drupal_layoutbuilder-templates-modal__header__logo',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            BaseElementView = BaseContainer.extend({
                ...
                className: function className() {
                    var classes = 'drupal_layoutbuilder-element drupal_layoutbuilder-element-edit-mode ' + this.getElementUniqueID();

                    if (this.toggleEditTools) {
                        classes += ' drupal_layoutbuilder-element--toggle-edit-tools';
                    }
                ...
                ui: function ui() {
                    return {
                        tools: '> .drupal_layoutbuilder-element-overlay > .drupal_layoutbuilder-editor-element-settings',
                        editButton: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-edit',
                        duplicateButton: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-duplicate',
                        addButton: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-add',
                        removeButton: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-remove'
                    };
                },
                ...
                toggleVisibilityClass: function toggleVisibilityClass() {
                    this.$el.toggleClass('drupal_layoutbuilder-edit-hidden', !!this.model.get('hidden'));
                },
                ...
                runReadyTrigger: function runReadyTrigger() {
                    ...
                    _.defer(function () {
                        ...
                        self.$el.find('.drupal_layoutbuilder-element.drupal_layoutbuilder-' + self.model.get('elType') + ':not(.drupal_layoutbuilder-element-edit-mode)').each(function () {
                ...
                getElementUniqueID: function getElementUniqueID() {
                    return 'drupal_layoutbuilder-element-' + this.getID();
                },
                ...
                getDynamicParsingSettings: function getDynamicParsingSettings() {
                    ...
                    return {
                        onServerRequestStart: function onServerRequestStart() {
                            self.$el.addClass('drupal_layoutbuilder-loading');
                        },
                        onServerRequestEnd: function onServerRequestEnd() {
                            self.render();

                            self.$el.removeClass('drupal_layoutbuilder-loading');
                        }
                    };
                },
                ...
                onRender: function onRender() {
                    ...
                    if (this.toggleEditTools) {
                        ...
                        this.ui.tools.hoverIntent(function () {
                            editButton.addClass('drupal_layoutbuilder-active');
                        }, function () {
                            editButton.removeClass('drupal_layoutbuilder-active');
                        }, { timeout: 500 });
                    }
                },
                ...
                onMouseDown: function onMouseDown(event) {
                    if (jQuery(event.target).closest('.drupal_layoutbuilder-inline-editing').length) {
                        return;
                    }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlsStack = Marionette.CompositeView.extend({
                className: 'drupal_layoutbuilder-panel-controls-stack',

                classes: {
                    popover: 'drupal_layoutbuilder-controls-popover'
                },
                ...
                ui: function ui() {
                    return {
                        tabs: '.drupal_layoutbuilder-panel-navigation-tab',
                        reloadButton: '.drupal_layoutbuilder-update-preview-button'
                    };
                },
                ...
                activateTab: function activateTab(tabName) {
                    ...
                    // this.ui.tabs.removeClass('drupal_layoutbuilder-active').filter('[data-tab="' + tabName + '"]').addClass('drupal_layoutbuilder-active');
                ...
                openActiveSection: function openActiveSection() {
                    ...
                    if (activeSectionView[0]) {
                        activeSectionView[0].$el.addClass('drupal_layoutbuilder-open');
                    }
                },
                ...
                onDeviceModeChange: function onDeviceModeChange() {
                    this.$el.removeClass('drupal_layoutbuilder-responsive-switchers-open');
                },

                onChildviewControlSectionClicked: function onChildviewControlSectionClicked(childView) {
                    var isSectionOpen = childView.$el.hasClass('drupal_layoutbuilder-open');
                ...
                onChildviewResponsiveSwitcherClick: function onChildviewResponsiveSwitcherClick(childView, device) {
                    if ('desktop' === device) {
                        this.$el.toggleClass('drupal_layoutbuilder-responsive-switchers-open');
                    }
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlsCSSParser = ViewModule.extend({
                ...
                getDefaultElements: function getDefaultElements() {
                    return {
                        $stylesheetElement: jQuery('<style>', { id: 'drupal_layoutbuilder-style-' + this.getSettings('id') })
                    };
                },
                ...
                addRepeaterControlsStyleRules: function addRepeaterControlsStyleRules(repeaterValues, repeaterControlsItems, controls, placeholders, replacements) {
                    ...
                    repeaterControlsItems.forEach(function (item, index) {
                        ...
                        self.addStyleRules(item, itemModel.attributes, controls, placeholders.concat(['{{CURRENT_ITEM}}']), replacements.concat(['.drupal_layoutbuilder-repeater-item-' + itemModel.get('_id')]));
                    });
                },
                ...
                addDynamicControlStyleRules: function addDynamicControlStyleRules(value, control) {
                    ...
                    elementor.dynamicTags.parseTagsText(value, control.dynamic, function (id, name, settings) {
                        ...
                        self.addStyleRules(tagSettingsModel.getStyleControls(), tagSettingsModel.attributes, tagSettingsModel.controls, ['{{WRAPPER}}'], ['#drupal_layoutbuilder-tag-' + id]);
                    });
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryHeaderView = Marionette.LayoutView.extend({
                ...
                className: 'drupal_layoutbuilder-templates-modal__header',

                template: '#tmpl-drupal_layoutbuilder-templates-modal__header',

                regions: {
                    logoArea: '.drupal_layoutbuilder-templates-modal__header__logo-area',
                    tools: '#drupal_layoutbuilder-template-library-header-tools',
                    menuArea: '.drupal_layoutbuilder-templates-modal__header__menu-area'
                },

                ui: {
                    closeModal: '.drupal_layoutbuilder-templates-modal__header__close'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryLoadingView = Marionette.ItemView.extend({
                id: 'drupal_layoutbuilder-template-library-loading',

                template: '#tmpl-drupal_layoutbuilder-template-library-loading'
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            SortableBehavior = Marionette.Behavior.extend({
                ...
                activate: function activate() {
                    ...
                    var $childViewContainer = this.getChildViewContainer(),
                        defaultSortableOptions = {
                            ...
                            placeholder: 'drupal_layoutbuilder-sortable-placeholder drupal_layoutbuilder-' + this.getOption('elChildType') + '-placeholder',
                            cursorAt: {
                                top: 20,
                                left: 25
                            },
                            helper: this._getSortableHelper.bind(this),
                            cancel: 'input, textarea, button, select, option, .drupal_layoutbuilder-inline-editing, .drupal_layoutbuilder-tab-title'
                ...
                _getSortableHelper: function _getSortableHelper(event, $item) {
                    ...
                    return '<div style="height: 84px; width: 125px;" class="drupal_layoutbuilder-sortable-helper drupal_layoutbuilder-sortable-helper-' + model.get('elType') + '"><div class="icon"><i class="' + model.getIcon() + '"></i></div><div class="drupal_layoutbuilder-element-title-wrapper"><div class="title">' + model.getTitle() + '</div></div></div>';
                },
                ...
                onSortOver: function onSortOver(event) {
                    ...
                    jQuery(event.target).addClass('drupal_layoutbuilder-draggable-over').attr({
                        'data-dragged-element': model.get('elType'),
                        'data-dragged-is-inner': model.get('isInner')
                    });

                    this.$el.addClass('drupal_layoutbuilder-dragging-on-child');
                },

                onSortOut: function onSortOut(event) {
                    event.stopPropagation();

                    jQuery(event.target).removeClass('drupal_layoutbuilder-draggable-over').removeAttr('data-dragged-element data-dragged-is-inner');

                    this.$el.removeClass('drupal_layoutbuilder-dragging-on-child');
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            InsertTemplateHandler = Marionette.Behavior.extend({
                ui: {
                    insertButton: '.drupal_layoutbuilder-template-library-template-insert'
                },
                ...
                initDialog: function initDialog() {
                    InsertTemplateHandler.dialog = elementor.dialogsManager.createWidget('confirm', {
                        id: 'drupal_layoutbuilder-insert-template-settings-dialog',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryTemplateView = Marionette.ItemView.extend({
                className: function className() {
                    var classes = 'drupal_layoutbuilder-template-library-template',
                        source = this.model.get('source');

                    classes += ' drupal_layoutbuilder-template-library-template-' + source;

                    if ('remote' === source) {
                        classes += ' drupal_layoutbuilder-template-library-template-' + this.model.get('type');
                    }

                    if (this.model.get('isPro')) {
                        classes += ' drupal_layoutbuilder-template-library-pro-template';
                    }
                ...
                ui: function ui() {
                    return {
                        previewButton: '.drupal_layoutbuilder-template-library-template-preview'
                    };
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            SectionView = BaseElementView.extend({
                template: Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-section-content'),
                ...
                className: function className() {
                    ...
                    return classes + ' drupal_layoutbuilder-section drupal_layoutbuilder-' + type + '-section';
                },
                ...
                childViewContainer: '> .drupal_layoutbuilder-container > .drupal_layoutbuilder-row',
                ...
                getSortableOptions: function getSortableOptions() {
                    var sectionConnectClass = this.isInner() ? '.drupal_layoutbuilder-inner-section' : '.drupal_layoutbuilder-top-section';

                    return {
                        connectWith: sectionConnectClass + ' > .drupal_layoutbuilder-container > .drupal_layoutbuilder-row',
                        handle: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-edit',
                        items: '> .drupal_layoutbuilder-column',
                ...
                _checkIsFull: function _checkIsFull() {
                    this.$el.toggleClass('drupal_layoutbuilder-section-filled', this.isCollectionFilled());
                },
            ...
            var AddSectionBase = function (_Marionette$ItemView) {
                ...
                _createClass(AddSectionBase, [{
                    ...
                    value: function template() {
                        return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-add-section');
                    }
                }, {
                    key: 'attributes',
                    ...
                    value: function ui() {
                        return {
                            addNewSection: '.drupal_layoutbuilder-add-new-section',
                            closeButton: '.drupal_layoutbuilder-add-section-close',
                            addSectionButton: '.drupal_layoutbuilder-add-section-button',
                            addTemplateButton: '.drupal_layoutbuilder-add-template-button',
                            selectPreset: '.drupal_layoutbuilder-select-preset',
                            presets: '.drupal_layoutbuilder-preset'
                        };
                    }
                }, {
                    key: 'events',
                    ...
                    value: function className() {
                        return 'drupal_layoutbuilder-add-section drupal_layoutbuilder-visible-desktop';
                    }
                }, {
                    key: 'addSection',
                    ...
                    value: function onRender() {
                        this.$el.html5Droppable({
                            axis: ['vertical'],
                            groups: ['drupal_layoutbuilder-element'],
                            placeholder: false,
                            currentElementClass: 'drupal_layoutbuilder-html5dnd-current-element',
                            hasDraggingOnChildClass: 'drupal_layoutbuilder-dragging-on-child',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            InnerTabsBehavior = Marionette.Behavior.extend({
                ...
                handleInnerTabs: function handleInnerTabs(parent) {
                    var closedClass = 'drupal_layoutbuilder-tab-close',
                        activeClass = 'drupal_layoutbuilder-tab-active',
                        tabsWrappers = parent.children.filter(function (view) {
                            return 'tabs' === view.model.get('type');
                        });

                    _.each(tabsWrappers, function (view) {
                        view.$el.find('.drupal_layoutbuilder-control-content').remove();
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlBoxShadowItemView = ControlMultipleBaseItemView.extend({
                ui: function ui() {
                    ...
                    ui.sliders = '.drupal_layoutbuilder-slider';
                    ui.colors = '.drupal_layoutbuilder-shadow-color-picker';
                ...
                initSliders: function initSliders() {
                    ...
                    this.ui.sliders.each(function () {
                        var $slider = jQuery(this),
                            $input = $slider.next('.drupal_layoutbuilder-slider-input').find('input');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            RepeaterRowView = Marionette.CompositeView.extend({
                template: Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-repeater-row'),

                className: 'drupal_layoutbuilder-repeater-fields',

                ui: {
                    duplicateButton: '.drupal_layoutbuilder-repeater-tool-duplicate',
                    editButton: '.drupal_layoutbuilder-repeater-tool-edit',
                    removeButton: '.drupal_layoutbuilder-repeater-tool-remove',
                    itemTitle: '.drupal_layoutbuilder-repeater-row-item-title'
                },
                ...
                childViewContainer: '.drupal_layoutbuilder-repeater-row-controls',
                ...
                onChildviewResponsiveSwitcherClick: function onChildviewResponsiveSwitcherClick(childView, device) {
                    if ('desktop' === device) {
                        elementor.getPanelView().getCurrentPageView().$el.toggleClass('drupal_layoutbuilder-responsive-switchers-open');
                    }
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-global',

                id: 'drupal_layoutbuilder-panel-global',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsElementView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-element-library-element',

                className: 'drupal_layoutbuilder-element-wrapper',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeColorsView = PanelSchemeBaseView.extend({
                ui: function ui() {
                    ...
                    ui.systemSchemes = '.drupal_layoutbuilder-panel-scheme-color-system-scheme';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeBaseView = Marionette.CompositeView.extend({
                id: function id() {
                    return 'drupal_layoutbuilder-panel-scheme-' + this.getType();
                },

                className: function className() {
                    return 'drupal_layoutbuilder-panel-scheme drupal_layoutbuilder-panel-scheme-' + this.getUIType();
                },

                childViewContainer: '.drupal_layoutbuilder-panel-scheme-items',

                getTemplate: function getTemplate() {
                    return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-panel-schemes-' + this.getType());
                },
                ...
                ui: function ui() {
                    return {
                        saveButton: '.drupal_layoutbuilder-panel-scheme-save .drupal_layoutbuilder-button',
                        discardButton: '.drupal_layoutbuilder-panel-scheme-discard .drupal_layoutbuilder-button',
                        resetButton: '.drupal_layoutbuilder-panel-scheme-reset .drupal_layoutbuilder-button'
                    };
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeItemView = Marionette.ItemView.extend({
                getTemplate: function getTemplate() {
                    return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-panel-scheme-' + this.getUIType() + '-item');
                },

                className: function className() {
                    return 'drupal_layoutbuilder-panel-scheme-item';
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var App = Marionette.Application.extend({
                ...
                channels: {
                    editor: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:editor'),
                    data: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:data'),
                    panelElements: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:panelElements'),
                    dataEditMode: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:editmode'),
                    deviceMode: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:deviceMode'),
                    templates: Backbone.Radio.channel('DRUPAL_LAYOUTBUILDER:templates')
                },
                ...
                backgroundClickListeners: {
                    popover: {
                        element: '.drupal_layoutbuilder-controls-popover',
                        ignore: '.drupal_layoutbuilder-control-popover-toggle-toggle, .drupal_layoutbuilder-control-popover-toggle-toggle-label, .select2-container'
                    },
                    tagsList: {
                        element: '.drupal_layoutbuilder-tags-list',
                        ignore: '.drupal_layoutbuilder-control-dynamic-switcher'
                    }
                },
                ...
                initPreview: function initPreview() {
                    ...
                    this.$previewWrapper = $('#drupal_layoutbuilder-preview');

                    this.$previewResponsiveWrapper = $('#drupal_layoutbuilder-preview-responsive-wrapper');

                    var previewIframeId = 'drupal_layoutbuilder-preview-iframe';
                ...
                initClearPageDialog: function initClearPageDialog() {
                    ...
                    self.getClearPageDialog = function () {
                        ...
                        dialog = this.dialogsManager.createWidget('confirm', {
                            id: 'drupal_layoutbuilder-clear-page-dialog',
                    ...
                    hotKeysHandlers[keysDictionary.del] = {
                        deleteElement: {
                            isWorthHandling: function isWorthHandling(event) {
                                ...
                                if ($target.is(':input, .drupal_layoutbuilder-input')) {
                                    return false;
                                }
                ...
                initNavigator: function initNavigator() {
                    this.addRegions({
                        navigator: {
                            el: '#drupal_layoutbuilder-navigator',
                ...
                preventClicksInsideEditor: function preventClicksInsideEditor() {
                    ...
                    this.$previewContents.on('click', function (event) {
                        ...
                        if ($target.closest('a:not(.drupal_layoutbuilder-clickable)').length) {
                            event.preventDefault();
                        }
                ...
                showFatalErrorDialog: function showFatalErrorDialog(options) {
                    var defaultOptions = {
                        id: 'drupal_layoutbuilder-fatal-error-dialog',
                        headerMessage: '',
                        message: '',
                        position: {
                            my: 'center center',
                ...
                enterPreviewMode: function enterPreviewMode(hidePanel) {
                    ...
                    $elements.removeClass('drupal_layoutbuilder-editor-active').addClass('drupal_layoutbuilder-editor-preview');

                    this.$previewElementorEl.removeClass('drupal_layoutbuilder-edit-area-active').addClass('drupal_layoutbuilder-edit-area-preview');
                ...
                exitPreviewMode: function exitPreviewMode() {
                    elementorFrontend.getElements('$body').add(this.$body).removeClass('drupal_layoutbuilder-editor-preview').addClass('drupal_layoutbuilder-editor-active');

                    this.$previewElementorEl.removeClass('drupal_layoutbuilder-edit-area-preview').addClass('drupal_layoutbuilder-edit-area-active');
                },
                ...
                reloadPreview: function reloadPreview() {
                    jQuery('#drupal_layoutbuilder-preview-loading').show();
                ...
                changeDeviceMode: function changeDeviceMode(newDeviceMode) {
                    ...
                    this.$body.removeClass('drupal_layoutbuilder-device-' + oldDeviceMode).addClass('drupal_layoutbuilder-device-' + newDeviceMode);
                ...
                onStart: function onStart() {
                    ...
                    Backbone.Radio.tuneIn('DRUPAL_LAYOUTBUILDER');
                ...
                onPreviewLoaded: function onPreviewLoaded() {
                    ...
                    this.$previewContents.children().addClass('drupal_layoutbuilder-html');

                    elementorFrontend.getElements('$body').addClass('drupal_layoutbuilder-editor-active');

                    if (!elementor.userCan('design')) {
                        elementorFrontend.getElements('$body').addClass('drupal_layoutbuilder-editor-content-only');
                    }

                    this.changeDeviceMode(this._defaultDeviceMode);

                    jQuery('#drupal_layoutbuilder-loading, #drupal_layoutbuilder-preview-loading').fadeOut(600);
                ...
                onPreviewLoadingError: function onPreviewLoadingError() {
                    open(document.getElementById("drupal_layoutbuilder-preview-iframe").contentWindow.location.href, '_self');
                    document.getElementById("drupal_layoutbuilder-editor-wrapper").innerHTML += "<div id='drupal_layoutbuilder-editor-block' style='position: fixed;z-index: 99;inset: 0;background: #000000aa;'></div>";
                    // this.showFatalErrorDialog({
                ...
                function Heartbeat() {
                    ...
                    jQuery(document).on({
                        ...
                        'heartbeat-tick.wp-refresh-nonces': function heartbeatTickWpRefreshNonces(event, response) {
                            var nonces = response['drupal_layoutbuilder-refresh-nonces'];
            ...
            var _class = function (_BaseRegion) {
                ...
                _createClass(_class, [{
                    ...
                    value: function getDraggableOptions() {
                        return {
                            iframeFix: true,
                            handle: '#drupal_layoutbuilder-navigator__header',
                    ...
                    key: 'dock',
                    value: function dock() {
                        elementor.$body.addClass('drupal_layoutbuilder-navigator-docked');
                    ...
                    value: function undock(silent) {
                        elementor.$body.removeClass('drupal_layoutbuilder-navigator-docked');
                    ...
                    value: function onDrag(event, ui) {
                        ...
                        elementor.$body.toggleClass('drupal_layoutbuilder-navigator--dock-hint', elementor.config.is_rtl ? isOutOfLeft : isOutOfRight);
                    }
                }, {
                    key: 'onDragStop',
                    value: function onDragStop(event, ui) {
                        ...
                        elementor.$body.removeClass('drupal_layoutbuilder-navigator--dock-hint');
                    }
                }, {
            ...
            var _class = function (_Marionette$LayoutVie) {
                ...
                _createClass(_class, [{
                    ...
                    value: function getTemplate() {
                        return '#tmpl-drupal_layoutbuilder-navigator';
                    }
                }, {
                    key: 'id',
                    value: function id() {
                        return 'drupal_layoutbuilder-navigator__inner';
                    }
                }, {
                    key: 'ui',
                    value: function ui() {
                        return {
                            toggleAll: '#drupal_layoutbuilder-navigator__toggle-all',
                            close: '#drupal_layoutbuilder-navigator__close'
                        };
                    }
                }, {
                    key: 'events',
                    ...
                    value: function regions() {
                        return {
                            elements: '#drupal_layoutbuilder-navigator__elements'
                        };
                    }
                }, {
                    key: 'toggleAll',
                    value: function toggleAll() {
                        var state = 'expand' === this.ui.toggleAll.data('drupal_layoutbuilder-action'),
                            classes = ['eicon-collapse', 'eicon-expand'];

                        this.ui.toggleAll.data('drupal_layoutbuilder-action', state ? 'collapse' : 'expand').removeClass(classes[+state]).addClass(classes[+!state]);
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var _class = function (_Marionette$Composite) {
                ...
                _createClass(_class, [{
                    key: 'getTemplate',
                    value: function getTemplate() {
                        return '#tmpl-drupal_layoutbuilder-navigator__elements';
                    }
                }, {
                    key: 'ui',
                    value: function ui() {
                        return {
                            item: '> .drupal_layoutbuilder-navigator__item',
                            title: '> .drupal_layoutbuilder-navigator__item .drupal_layoutbuilder-navigator__element__title__text',
                            toggle: '> .drupal_layoutbuilder-navigator__item > .drupal_layoutbuilder-navigator__element__toggle',
                            toggleList: '> .drupal_layoutbuilder-navigator__item > .drupal_layoutbuilder-navigator__element__list-toggle',
                            elements: '> .drupal_layoutbuilder-navigator__elements'
                        };
                    }
                }, {
                    ...
                    value: function className() {
                        ...
                        var classes = 'drupal_layoutbuilder-navigator__element';

                        if (elType) {
                            classes += ' drupal_layoutbuilder-navigator__element-' + elType;
                        }

                        if (this.hasChildren()) {
                            classes += ' drupal_layoutbuilder-navigator__element--has-children';
                        }
                    ...
                    value: function initialize() {
                        ...
                        this.childViewContainer = '.drupal_layoutbuilder-navigator__elements';
                    ...
                    value: function toggleList(state, callback) {
                        ...
                        var isActive = this.ui.item.hasClass('drupal_layoutbuilder-active');

                        if (isActive === state) {
                            return;
                        }

                        this.ui.item.toggleClass('drupal_layoutbuilder-active', state);
                    ...
                    value: function toggleHiddenClass() {
                        this.$el.toggleClass('drupal_layoutbuilder-navigator__element--hidden', !!this.model.get('hidden'));
                    }
                }, {
                    ...
                    value: function addEditingClass() {
                        this.ui.item.addClass('drupal_layoutbuilder-editing');
                    }
                }, {
                    key: 'removeEditingClass',
                    value: function removeEditingClass() {
                        this.ui.item.removeClass('drupal_layoutbuilder-editing');
                    }
                }, {
                    ...
                    value: function activateSortable() {
                        ...
                        this.ui.elements.sortable({
                            items: '> .drupal_layoutbuilder-navigator__element',
                            placeholder: 'ui-sortable-placeholder',
                            axis: 'y',
                            forcePlaceholderSize: true,
                            connectWith: '.drupal_layoutbuilder-navigator__element-' + this.model.get('elType') + ' ' + this.ui.elements.selector,
                    ...
                    value: function onSortStart(event, ui) {
                        ...
                        jQuery(ui.item).children('.drupal_layoutbuilder-navigator__item').trigger('click');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var _class = function (_Marionette$ItemView) {
                ...
                _createClass(_class, [{
                    key: 'getTemplate',
                    value: function getTemplate() {
                        return '#tmpl-drupal_layoutbuilder-navigator__elements--empty';
                    }
                }, {
                    key: 'className',
                    value: function className() {
                        return 'drupal_layoutbuilder-empty-view';
                    }
                }, {
                    key: 'onRendr',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var _class = function (_Marionette$ItemView) {
                ...
                _createClass(_class, [{
                    key: 'getTemplate',
                    value: function getTemplate() {
                        return '#tmpl-drupal_layoutbuilder-navigator__root--empty';
                    }
                }, {
                    key: 'className',
                    value: function className() {
                        return 'drupal_layoutbuilder-nerd-box';
                    }
                }]);
                ...
                self.getImageUrl = function (image) {
                    ...
                    if (!imageUrl) {
                        ...
                        jQuery.ajax({
                            ...
                            method: 'GET',
                            data: {
                                action: 'get_style_image_url',
                                image_id: image.id,
                                image_size: image.size
                            },
                            async: false,
                            success: function (response) {
                                temp_imageUrl = response;
                            }
                        });

                        if (temp_imageUrl != '') {
                            return temp_imageUrl;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Debug = function Debug() {
                ...
                var initSettings = function initSettings() {
                    settings = {
                        debounceDelay: 500,
                        urlsToWatch: ['layout_editor/assets']
                    };
                };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            Schemes = function Schemes() {
                var self = this,
                    ...
                    schemes = {},
                    settings = {
                        selectorWrapperPrefix: '.drupal_layoutbuilder-widget-'
                    },
                    elements = {};
                ...
                var initElements = function initElements() {
                    elements.$style = jQuery('<style>', {
                        id: 'drupal_layoutbuilder-style-scheme'
                    });
            ...
            TemplateLibraryManager = function TemplateLibraryManager() {
                ...
                this.init = function () {
                    ...
                    elementor.addBackgroundClickListener('libraryToggleMore', {
                        element: '.drupal_layoutbuilder-template-library-template-more'
                    });
                };
                ...
                this.getDeleteDialog = function () {
                    if (!deleteDialog) {
                        deleteDialog = elementor.dialogsManager.createWidget('confirm', {
                            id: 'drupal_layoutbuilder-template-library-delete-dialog',
                ...
                this.getErrorDialog = function () {
                    if (!errorDialog) {
                        errorDialog = elementor.dialogsManager.createWidget('alert', {
                            id: 'drupal_layoutbuilder-template-library-error-dialog',
                ...
                this.startModal = function (customStartIntent) {
                    ...
                    self.requestLibraryData({
                        ...
                        onUpdate: function onUpdate() {
                            ...
                            if (isSameIntent && 'drupal_layoutbuilder-template-library-templates' === layout.modalContent.currentView.id) {
                                return;
                            }
                ...
                this.showErrorDialog = function (errorMessage) {
                    ...
                    self.getErrorDialog().setMessage(elementor.translate('templates_request_error') + '<div id="drupal_layoutbuilder-template-library-error-info">' + errorMessage + '</div>').show();
                };
            };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = BaseModalLayout.extend({
                ...
                getModalOptions: function getModalOptions() {
                    return {
                        id: 'drupal_layoutbuilder-template-library-modal'
                    };
                },
                ...
                getTemplateActionButton: function getTemplateActionButton(templateData) {
                    var viewId = '#tmpl-drupal_layoutbuilder-template-library-' + (templateData.isPro ? 'get-pro-button' : 'insert-button');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-header-actions',

                id: 'drupal_layoutbuilder-template-library-header-actions',

                ui: {
                    'import': '#drupal_layoutbuilder-template-library-header-import i',
                    sync: '#drupal_layoutbuilder-template-library-header-sync i',
                    save: '#drupal_layoutbuilder-template-library-header-save i'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                options: {
                    activeClass: 'drupal_layoutbuilder-active'
                },

                template: '#tmpl-drupal_layoutbuilder-template-library-header-menu',

                id: 'drupal_layoutbuilder-template-library-header-menu',

                ui: {
                    menuItems: '.drupal_layoutbuilder-template-library-menu-item'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-header-preview',

                id: 'drupal_layoutbuilder-template-library-header-preview',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-header-back',

                id: 'drupal_layoutbuilder-template-library-header-preview-back',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryCollectionView = Marionette.CompositeView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-templates',

                id: 'drupal_layoutbuilder-template-library-templates',

                childViewContainer: '#drupal_layoutbuilder-template-library-templates-container',
                ...
                ui: {
                    textFilter: '#drupal_layoutbuilder-template-library-filter-text',
                    selectFilter: '.drupal_layoutbuilder-template-library-filter-select',
                    myFavoritesFilter: '#drupal_layoutbuilder-template-library-filter-my-favorites',
                    orderInputs: '.drupal_layoutbuilder-template-library-order-input',
                    orderLabels: '.drupal_layoutbuilder-template-library-order-label'
                },
                ...
                toggleFilterClass: function toggleFilterClass() {
                    this.$el.toggleClass('drupal_layoutbuilder-templates-filter-active', !!(elementor.templates.getFilter('text') || elementor.templates.getFilter('favorite')));
                },
                ...
                onSelectFilterChange: function onSelectFilterChange(event) {
                    var $select = jQuery(event.currentTarget),
                        filterName = $select.data('drupal_layoutbuilder-filter');
                ...
                onOrderLabelsClick: function onOrderLabelsClick(event) {
                    ...
                    $clickedInput.toggleClass('drupal_layoutbuilder-template-library-order-reverse', toggle);

                    this.order($clickedInput.val(), $clickedInput.hasClass('drupal_layoutbuilder-template-library-order-reverse'));
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryTemplateLocalView = TemplateLibraryTemplateView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-template-local',

                ui: function ui() {
                    return _.extend(TemplateLibraryTemplateView.prototype.ui.apply(this, arguments), {
                        deleteButton: '.drupal_layoutbuilder-template-library-template-delete',
                        morePopup: '.drupal_layoutbuilder-template-library-template-more',
                        toggleMore: '.drupal_layoutbuilder-template-library-template-more-toggle',
                        toggleMoreIcon: '.drupal_layoutbuilder-template-library-template-more-toggle i'
                    });
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryTemplateRemoteView = TemplateLibraryTemplateView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-template-remote',

                ui: function ui() {
                    return jQuery.extend(TemplateLibraryTemplateView.prototype.ui.apply(this, arguments), {
                        favoriteCheckbox: '.drupal_layoutbuilder-template-library-template-favorite-input'
                    });
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryTemplatesEmptyView = Marionette.ItemView.extend({
                id: 'drupal_layoutbuilder-template-library-templates-empty',

                template: '#tmpl-drupal_layoutbuilder-template-library-templates-empty',

                ui: {
                    title: '.drupal_layoutbuilder-template-library-blank-title',
                    message: '.drupal_layoutbuilder-template-library-blank-message'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibrarySaveTemplateView = Marionette.ItemView.extend({
                id: 'drupal_layoutbuilder-template-library-save-template',

                template: '#tmpl-drupal_layoutbuilder-template-library-save-template',

                ui: {
                    form: '#drupal_layoutbuilder-template-library-save-template-form',
                    submitButton: '#drupal_layoutbuilder-template-library-save-template-submit'
                },
                ...
                onFormSubmit: function onFormSubmit(event) {
                    ...
                    this.ui.submitButton.addClass('drupal_layoutbuilder-button-state');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryImportView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-import',

                id: 'drupal_layoutbuilder-template-library-import',

                ui: {
                    uploadForm: '#drupal_layoutbuilder-template-library-import-form',
                    fileInput: '#drupal_layoutbuilder-template-library-import-form-input'
                },
                ...
                onFormDragEnter: function onFormDragEnter() {
                    this.ui.uploadForm.addClass('drupal_layoutbuilder-drag-over');
                },
                ...
                onFormDragLeave: function onFormDragLeave(event) {
                    ...
                    this.ui.uploadForm.removeClass('drupal_layoutbuilder-drag-over');
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            TemplateLibraryPreviewView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-template-library-preview',

                id: 'drupal_layoutbuilder-template-library-preview',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.LayoutView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-history-page',

                regions: {
                    content: '#drupal_layoutbuilder-panel-history-content'
                },
                ...
                activateTab: function activateTab(tabName) {
                    this.ui.tabs.removeClass('drupal_layoutbuilder-active').filter('[data-view="' + tabName + '"]').addClass('drupal_layoutbuilder-active');
                ...
                onDestroy: function onDestroy() {
                    elementor.getPanelView().getFooterView().ui.history.removeClass('drupal_layoutbuilder-open');
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.CompositeView.extend({
                id: 'drupal_layoutbuilder-panel-history',

                template: '#tmpl-drupal_layoutbuilder-panel-history-tab',

                childView: Marionette.ItemView.extend({
                    template: '#tmpl-drupal_layoutbuilder-panel-history-item',
                    ui: {
                        item: '.drupal_layoutbuilder-history-item'
                    },
                    triggers: {
                ...
                childViewContainer: '#drupal_layoutbuilder-history-list',
                ...
                updateCurrentItem: function updateCurrentItem(element) {
                    var currentItemClass = 'drupal_layoutbuilder-history-item-current';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.CompositeView.extend({
                id: 'drupal_layoutbuilder-panel-revisions',

                template: '#tmpl-drupal_layoutbuilder-panel-revisions',

                childView: __webpack_require__(82),

                childViewContainer: '#drupal_layoutbuilder-revisions-list',

                ui: {
                    discard: '.drupal_layoutbuilder-panel-scheme-discard .drupal_layoutbuilder-button',
                    apply: '.drupal_layoutbuilder-panel-scheme-save .drupal_layoutbuilder-button'
                },
                ...
                getRevisionViewData: function getRevisionViewData(revisionView) {
                    ...
                    this.jqueryXhr = elementor.history.revisions.getRevisionDataAsync(revisionView.model.get('id'), {
                        success: function success(data) {
                            ...
                            revisionView.$el.removeClass('drupal_layoutbuilder-revision-item-loading');
                ...
                deleteRevision: function deleteRevision(revisionView) {
                    ...
                    revisionView.$el.addClass('drupal_layoutbuilder-revision-item-loading');
                ...
                onDiscardClick: function onDiscardClick() {
                    ...
                    if (this.currentPreviewItem) {
                        this.currentPreviewItem.$el.removeClass('drupal_layoutbuilder-revision-current-preview');
                    }
                },
                ...
                onRenderCollection: function onRenderCollection() {
                    ...
                    if (currentPreviewModel) {
                        ...
                        this.currentPreviewItem.$el.addClass('drupal_layoutbuilder-revision-current-preview');
                    }
                },
                ...
                onChildviewDetailsAreaClick: function onChildviewDetailsAreaClick(childView) {
                    ...
                    if (self.currentPreviewItem) {
                        self.currentPreviewItem.$el.removeClass('drupal_layoutbuilder-revision-current-preview');
                    }

                    childView.$el.addClass('drupal_layoutbuilder-revision-current-preview drupal_layoutbuilder-revision-item-loading');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-revisions-no-revisions',
                id: 'drupal_layoutbuilder-panel-revisions-no-revisions',
                className: 'drupal_layoutbuilder-nerd-box'
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.Behavior.extend({
                ...
                add: function add(models, toView, position) {
                    ...
                    // Fix for case the iframe has been reloaded and the old `drupal_layoutbuilder-inner` is not exist.
                    if (toView.$el.hasClass('drupal_layoutbuilder-inner') && toView.$el[0].ownerDocument !== elementor.$previewContents[0]) {
            ...
            ContextMenu = Module.extend({
                ...
                getDefaultSettings: function getDefaultSettings() {
                    return {
                        actions: {},
                        classes: {
                            list: 'drupal_layoutbuilder-context-menu-list',
                            group: 'drupal_layoutbuilder-context-menu-list__group',
                            groupPrefix: 'drupal_layoutbuilder-context-menu-list__group-',
                            item: 'drupal_layoutbuilder-context-menu-list__item',
                            itemTypePrefix: 'drupal_layoutbuilder-context-menu-list__item-',
                            itemTitle: 'drupal_layoutbuilder-context-menu-list__item__title',
                            itemShortcut: 'drupal_layoutbuilder-context-menu-list__item__shortcut',
                            iconShortcut: 'drupal_layoutbuilder-context-menu-list__item__icon',
                            itemDisabled: 'drupal_layoutbuilder-context-menu-list__item--disabled',
                            divider: 'drupal_layoutbuilder-context-menu-list__divider',
                            hidden: 'drupal_layoutbuilder-hidden'
                        }
                    };
                },
                    ...
                    this.getModal = function () {
                        if (!modal) {
                            modal = elementor.dialogsManager.createWidget('simple', {
                                className: 'drupal_layoutbuilder-context-menu',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var AddSectionView = function (_BaseAddSectionView) {
                ...
                _createClass(AddSectionView, [{
                    key: 'className',
                    value: function className() {
                        return _get(AddSectionView.prototype.__proto__ || Object.getPrototypeOf(AddSectionView.prototype), 'className', this).call(this) + ' drupal_layoutbuilder-add-section-inline';
                    }
                }, {
                    key: 'fadeToDeath',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ColumnView = BaseElementView.extend({
                template: Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-column-content'),

                emptyView: ColumnEmptyView,

                childViewContainer: '> .drupal_layoutbuilder-column-wrap > .drupal_layoutbuilder-widget-wrap',
                ...
                className: function className() {
                    ...
                    return classes + ' drupal_layoutbuilder-column drupal_layoutbuilder-' + type + '-column';
                },
                ...
                ui: function ui() {
                    ...
                    ui.columnInner = '> .drupal_layoutbuilder-column-wrap';

                    ui.percentsTooltip = '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-column-percents-tooltip';
                ...
                getSortableOptions: function getSortableOptions() {
                    return {
                        connectWith: '.drupal_layoutbuilder-widget-wrap',
                        items: '> .drupal_layoutbuilder-element'
                    };
                },

                changeChildContainerClasses: function changeChildContainerClasses() {
                    var emptyClass = 'drupal_layoutbuilder-element-empty',
                        populatedClass = 'drupal_layoutbuilder-element-populated';
                ...
                onRender: function onRender() {
                    ...
                    self.$el.html5Droppable({
                        items: ' > .drupal_layoutbuilder-column-wrap > .drupal_layoutbuilder-widget-wrap > .drupal_layoutbuilder-element, >.drupal_layoutbuilder-column-wrap > .drupal_layoutbuilder-widget-wrap > .drupal_layoutbuilder-empty-view > .drupal_layoutbuilder-first-add',
                        axis: ['vertical'],
                        groups: ['drupal_layoutbuilder-element'],
                        isDroppingAllowed: self.isDroppingAllowed.bind(self),
                        currentElementClass: 'drupal_layoutbuilder-html5dnd-current-element',
                        placeholderClass: 'drupal_layoutbuilder-sortable-placeholder drupal_layoutbuilder-widget-placeholder',
                        hasDraggingOnChildClass: 'drupal_layoutbuilder-dragging-on-child',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-empty-preview',

                className: 'drupal_layoutbuilder-empty-view',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.Behavior.extend({
                ...
                ui: function ui() {
                    return {
                        buttonPreview: '#drupal_layoutbuilder-panel-saver-button-preview',
                        buttonPublish: '#drupal_layoutbuilder-panel-saver-button-publish',
                        buttonSaveOptions: '#drupal_layoutbuilder-panel-saver-button-save-options',
                        buttonPublishLabel: '#drupal_layoutbuilder-panel-saver-button-publish-label',
                        menuSaveDraft: '#drupal_layoutbuilder-panel-saver-menu-save-draft',
                        lastEditedWrapper: '.drupal_layoutbuilder-last-edited-wrapper'
                    };
                },
                ...
                activateSaveButtons: function activateSaveButtons(hasChanges) {
                    ...
                    this.ui.buttonPublish.add(this.ui.menuSaveDraft).toggleClass('drupal_layoutbuilder-saver-disabled', !hasChanges);
                    this.ui.buttonSaveOptions.toggleClass('drupal_layoutbuilder-saver-disabled', !hasChanges);
                },
                    ...
                    if ('publish' === newStatus) {
                        elementor.notifications.showToast({
                            ...
                            buttons: [{
                                ...
                                callback: function callback() {
                                    open(elementor.config.document.urls.preview);
                                }
                            }]
                        });
                    }
                ...
                onBeforeSave: function onBeforeSave(options) {
                    ...
                    if ('autosave' === options.status) {
                        this.ui.lastEditedWrapper.addClass('drupal_layoutbuilder-state-active');
                    } else {
                        this.ui.buttonPublish.addClass('drupal_layoutbuilder-button-state');
                    }
                },

                onAfterSave: function onAfterSave(data) {
                    NProgress.done();
                    this.ui.buttonPublish.removeClass('drupal_layoutbuilder-button-state');
                    this.ui.lastEditedWrapper.removeClass('drupal_layoutbuilder-state-active');
                    this.refreshWpPreview();
                    this.setLastEdited(data);
                },

                setLastEdited: function setLastEdited(data) {
                    this.ui.lastEditedWrapper.removeClass('drupal_layoutbuilder-button-state').find('.drupal_layoutbuilder-last-edited').html(data.config.last_edited);
                },
                ...
                onClickButtonPreview: function onClickButtonPreview() {
                    ...
                    this.previewWindow = open(elementor.config.document.urls.preview, 'wp-preview-' + elementor.config.document.id);
                ...
                onClickButtonPublish: function onClickButtonPublish() {
                    ...
                    if (this.ui.buttonPublish.hasClass('drupal_layoutbuilder-saver-disabled')) {
                        return;
                    }
                ...
                refreshWpPreview: function refreshWpPreview() {
                    if (this.previewWindow) {
                        ...
                        try {
                            this.previewWindow.location.href = elementor.config.document.urls.preview;
                        } catch (e) {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.Behavior.extend({
                ...
                ui: {
                    tagArea: '.drupal_layoutbuilder-control-tag-area',
                    dynamicSwitcher: '.drupal_layoutbuilder-control-dynamic-switcher'
                },
                ...
                renderTools: function renderTools() {
                    ...
                    var $dynamicSwitcher = jQuery(Marionette.Renderer.render('#tmpl-drupal_layoutbuilder-control-dynamic-switcher'));
                ...
                toggleDynamicClass: function toggleDynamicClass() {
                    this.$el.toggleClass('drupal_layoutbuilder-control-dynamic-value', this.isDynamicMode());
                },
                ...
                createTagsList: function createTagsList() {
                    var tags = _.groupBy(this.getOption('tags'), 'group'),
                        ...
                        $tagsList = this.ui.tagsList = jQuery('<div>', { 'class': 'drupal_layoutbuilder-tags-list' }),
                        $tagsListInner = jQuery('<div>', { 'class': 'drupal_layoutbuilder-tags-list__inner' });
                    ...
                    jQuery.each(groups, function (groupName) {
                        ...
                        var group = this,
                            $groupTitle = jQuery('<div>', { 'class': 'drupal_layoutbuilder-tags-list__group-title' }).text(group.title);

                        $tagsListInner.append($groupTitle);

                        groupTags.forEach(function (tag) {
                            var $tag = jQuery('<div>', { 'class': 'drupal_layoutbuilder-tags-list__item' });
                    ...
                    $tagsListInner.on('click', '.drupal_layoutbuilder-tags-list__item', this.onTagsListItemClick.bind(this));
                ...
                onRender: function onRender() {
                    this.$el.addClass('drupal_layoutbuilder-control-dynamic');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                ...
                className: 'drupal_layoutbuilder-dynamic-cover drupal_layoutbuilder-input-style',
                ...
                ui: {
                    remove: '.drupal_layoutbuilder-dynamic-cover__remove'
                },
                ...
                getTemplate: function getTemplate() {
                    var config = this.getTagConfig(),
                        templateFunction = Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-control-dynamic-cover'),
                ...
                initSettingsPopup: function initSettingsPopup() {
                    var settingsPopupOptions = {
                        className: 'drupal_layoutbuilder-tag-settings-popup',
                        position: {
                            my: 'left top+5',
                            at: 'left bottom',
                            of: this.$el,
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                className: 'drupal_layoutbuilder-tag-controls-stack-empty',

                template: '#tmpl-drupal_layoutbuilder-tag-controls-stack-empty'
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlCodeEditorItemView = ControlBaseDataView.extend({
                ...
                ui: function ui() {
                    ...
                    ui.editor = '.drupal_layoutbuilder-code-editor';
                ...
                onReady: function onReady() {
                    ...
                    jQuery(self.editor.container).addClass('drupal_layoutbuilder-input-style drupal_layoutbuilder-code-editor');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlDimensionsItemView = ControlBaseUnitsItemView.extend({
                ui: function ui() {
                    ...
                    ui.controls = '.drupal_layoutbuilder-control-dimension > input:enabled';
                    ui.link = 'button.drupal_layoutbuilder-link-dimensions';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlMediaItemView = ControlBaseDataView.extend({
                ui: function ui() {
                    ...
                    ui.addImages = '.drupal_layoutbuilder-control-gallery-add';
                    ui.clearGallery = '.drupal_layoutbuilder-control-gallery-clear';
                    ui.galleryThumbnails = '.drupal_layoutbuilder-control-gallery-thumbnails';
                    ui.status = '.drupal_layoutbuilder-control-gallery-status-title';
                ...
                applySavedValue: function applySavedValue() {
                    ...
                    this.$el.toggleClass('drupal_layoutbuilder-gallery-has-images', hasImages).toggleClass('drupal_layoutbuilder-gallery-empty', !hasImages);
                    ...
                    this.getControlValue().forEach(function (image) {
                        var $thumbnail = jQuery('<div>', { 'class': 'drupal_layoutbuilder-control-gallery-thumbnail' });
            ...
            ControlImageDimensionsItemView = ControlMultipleBaseItemView.extend({
                ui: function ui() {
                    return {
                        ...
                        btnApply: 'button.drupal_layoutbuilder-image-dimensions-apply-button'
                    };
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlMediaItemView = ControlMultipleBaseItemView.extend({
                ui: function ui() {
                    ...
                    ui.controlMedia = '.drupal_layoutbuilder-control-media';
                    ui.mediaImage = '.drupal_layoutbuilder-control-media-image';
                    ui.mediaVideo = '.drupal_layoutbuilder-control-media-video';
                    ui.frameOpeners = '.drupal_layoutbuilder-control-preview-area';
                    ui.deleteButton = '.drupal_layoutbuilder-control-media-delete';
                ...
                applySavedValue: function applySavedValue() {
                    ...
                    this.ui.controlMedia.toggleClass('drupal_layoutbuilder-media-empty', !url);
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlOrderItemView = ControlMultipleBaseItemView.extend({
                ui: function ui() {
                    ...
                    ui.reverseOrderLabel = '.drupal_layoutbuilder-control-order-label';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlPopoverStarterView = ControlChooseView.extend({
                ui: function ui() {
                    ...
                    ui.popoverToggle = '.drupal_layoutbuilder-control-popover-toggle-toggle';
                ...
                onPopoverToggleClick: function onPopoverToggleClick() {
                    this.$el.next('.drupal_layoutbuilder-controls-popover').toggle();
                }
            }, {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlRepeaterItemView = ControlBaseDataView.extend({
                ui: {
                    btnAddRow: '.drupal_layoutbuilder-repeater-add',
                    fieldContainer: '.drupal_layoutbuilder-repeater-fields-wrapper'
                },
                ...
                childViewContainer: '.drupal_layoutbuilder-repeater-fields-wrapper',
                ...
                editRow: function editRow(rowView) {
                    if (this.currentEditableChild) {
                        ...
                        currentEditable.find('.drupal_layoutbuilder-wp-editor').each(function () {
                ...
                toggleMinRowsClass: function toggleMinRowsClass() {
                    ...
                    this.$el.toggleClass('drupal_layoutbuilder-repeater-has-minimum-rows', 1 >= this.collection.length);
                },
                ...
                onRender: function onRender() {
                    ...
                    this.ui.fieldContainer.sortable({ axis: 'y', handle: '.drupal_layoutbuilder-repeater-row-tools' });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlSectionItemView = ControlBaseView.extend({
                ui: function ui() {
                    ...
                    ui.heading = '.drupal_layoutbuilder-panel-heading';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlSliderItemView = ControlBaseUnitsItemView.extend({
                ui: function ui() {
                    ...
                    ui.slider = '.drupal_layoutbuilder-slider';
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlStructureItemView = ControlBaseDataView.extend({
                ui: function ui() {
                    ...
                    ui.resetStructure = '.drupal_layoutbuilder-control-structure-reset';
                ...
                onReady: function onReady() {
                    ...
                    this.ui.input.autocomplete({
                        ...
                        open: function open(event) {
                            jQuery(event.target).data('uiAutocomplete').menu.activeMenu.addClass('drupal_layoutbuilder-autocomplete-menu');
                        },
                        minLength: 2,
                        position: {
                        ...
                        .autocomplete('instance')._renderItem = function (ul, item) {
                            ...
                            return jQuery('<li role="option" id="mce-wp-autocomplete-' + item.ID + '">').append('<span>' + title + '</span>&nbsp;<span class="drupal_layoutbuilder-autocomplete-item-info">' + item.info + '</span>').appendTo(ul);
                        };
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            ControlWysiwygItemView = ControlBaseDataView.extend({
                ...
                ui: function ui() {
                    ...
                    jQuery.extend(ui, {
                        inputWrapper: '.drupal_layoutbuilder-control-input-wrapper'
                    });
                ...
                events: function events() {
                    return _.extend(ControlBaseDataView.prototype.events.apply(this, arguments), {
                        'keyup textarea.drupal_layoutbuilder-wp-editor': 'onBaseInputChange',
                        // TinyMCE syncs iframe → textarea then triggers 'change' (not keyup) on hide/batch edits.
                        'change textarea.drupal_layoutbuilder-wp-editor': 'onBaseInputChange'
                    });
                },
                ...
                initialize: function initialize() {
                    ...
                    if (!elementor.config.rich_editing_enabled) {
                        self.$el.addClass('drupal_layoutbuilder-rich-editing-disabled');

                        return;
                    }

                    // Keep toolbar1/toolbar2/plugins from tinyMCEPreInit.mceInit.elementorwpeditor (Drupal bundle).
                    // Overwriting plugins with a short list breaks init: toolbar still references spellchecker, wp_more, etc.
                    var editorConfig = {
                        id: self.editorID,
                        ...
                        setup: function (editor) {
                            ...
                            // Bind here: self.editor is only assigned once setup runs; onReady's setTimeout(100)
                            // often ran before init finished, threw on null editor, and broke the whole control.
                            editor.on('keyup change undo redo SetContent', self.saveEditor.bind(self));

                            editor.on('init', function () {

                                const body = editor.getBody();
                                if (body && body.firstChild) {
                                    editor.selection.select(body.firstChild, true);
                                    editor.selection.collapse(true);
                                    editor.nodeChanged();
                                    // Do not blur: it breaks focus when the panel opens and feels like "can't type".
                                }
                            });
                            ...
                            // Fix: prefill the link dialog with existing href
                            editor.on('ExecCommand', function (e) {
                                if (e.command === 'mceLink') {
                                    var node = editor.selection.getNode();
                                    if (node && node.nodeName === 'A' && node.href) {
                                        // WP’s wplink expects #wp-link-url
                                        setTimeout(function () {
                                            var input = document.querySelector('#wp-link-url');
                                            if (input) {
                ...
                applySavedValue: function applySavedValue() {
                    ...
                    // Update also the plain textarea (Text tab / no TinyMCE yet).
                ...
                onReady: function onReady() {
                    ...
                    if (elementor.config.rich_editing_enabled && window.tinymce && tinymce.get(self.editorID)) {
                        try {
                            tinymce.EditorManager.execCommand('mceRemoveEditor', true, self.editorID);
                        } catch (eRm) {}
                    }

                    if (window.QTags && QTags.instances[self.editorID]) {
                        try {
                            QTags.instances[self.editorID].remove();
                        } catch (eQt) {}

                        delete QTags.instances[self.editorID];
                    }
                    ...
                    // QuickTags / TinyMCE need the textarea in the DOM (injected above). Defer matches WP editor timing.
                    _.defer(function () {
                        quicktags({
                        ...
                        // TinyMCE often measures height 0 when the parent was display:none; refresh after paint.
                        requestAnimationFrame(function () {
                            var ed = window.tinymce && tinymce.get(self.editorID);

                            if (ed && !ed.destroyed && ed.getContainer()) {
                                try {
                                    if (ed.theme && typeof ed.theme.resizeTo === 'function') {
                                        ed.theme.resizeTo(null, 250);
                                    }
                                } catch (err) {}
            ...
            WidgetView = BaseElementView.extend({
                ...
                getTemplate: function getTemplate() {
                    ...
                    if ('remote' !== this.getTemplateType()) {
                        return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-' + editModel.get('widgetType') + '-content');
                    } else {
                        return _.template('');
                    }
                },
                ...
                className: function className() {
                    ...
                    return baseClasses + ' drupal_layoutbuilder-widget ' + elementor.getElementData(this.getEditModel()).html_wrapper_class;
                },
                ...
                behaviors: function behaviors() {
                    ...
                    _.extend(behaviors, {
                        InlineEditing: {
                            ...
                            inlineEditingClass: 'drupal_layoutbuilder-inline-editing'
                        }
                    });
                ...
                render: function render() {
                    if (this.model.isRemoteRequestActive()) {
                        ...
                        this.$el.addClass('drupal_layoutbuilder-element');
                ...
                handleEmptyWidget: function handleEmptyWidget() {
                    // TODO: REMOVE THIS !!
                    // TEMP CODING !!
                    this.$el.addClass('drupal_layoutbuilder-widget-empty').append('<i class="drupal_layoutbuilder-widget-empty-icon ' + this.getEditModel().getIcon() + '"></i>');
                },

                getTemplateType: function getTemplateType() {
                    if (null === this._templateType) {
                        var editModel = this.getEditModel(),
                            $template = jQuery('#tmpl-drupal_layoutbuilder-' + editModel.get('widgetType') + '-content');
                ...
                addInlineEditingAttributes: function addInlineEditingAttributes(key, toolbar) {
                    this.addRenderAttribute(key, {
                        'class': 'drupal_layoutbuilder-inline-editing',
                        'data-drupal_layoutbuilder-setting-key': key
                    });

                    if (toolbar) {
                        this.addRenderAttribute(key, {
                            'data-drupal_layoutbuilder-inline-editing-toolbar': toolbar
                        });
                    }
                },
                ...
                onModelBeforeRemoteRender: function onModelBeforeRemoteRender() {
                    this.$el.addClass('drupal_layoutbuilder-loading');
                },

                onBeforeDestroy: function onBeforeDestroy() {
                    // Remove old style from the DOM.
                    elementor.$previewContents.find('#drupal_layoutbuilder-style-' + this.model.cid).remove();
                },
                ...
                onModelRemoteRender: function onModelRemoteRender() {
                    ...
                    this.$el.removeClass('drupal_layoutbuilder-loading');
                    this.render();
                },
                ...
                onRender: function onRender() {
                    ...
                    self.$el.attr('data-element_type', editModel.get('widgetType') + '.' + skinType).removeClass('drupal_layoutbuilder-widget-empty').children('.drupal_layoutbuilder-widget-empty-icon').remove();
        ...
        (function (module, exports, __webpack_require__) {
            ...
            InlineEditingBehavior = Marionette.Behavior.extend({
                ...
                resolveInlineSettingKey: function resolveInlineSettingKey($el) {
                    if (!$el || !$el.length) {
                        return '';
                    }

                    return $el.attr('data-elementor-setting-key') || $el.attr('data-drupal_layoutbuilder-setting-key') || '';
                },

                resolveInlineToolbar: function resolveInlineToolbar($el) {
                    if (!$el || !$el.length) {
                        return '';
                    }

                    return $el.attr('data-elementor-inline-editing-toolbar') || $el.attr('data-drupal_layoutbuilder-inline-editing-toolbar') || '';
                },

                getEditingSettingKey: function getEditingSettingKey() {
                    return this.resolveInlineSettingKey(this.$currentEditingArea);
                },

                startEditing: function startEditing($element) {
                    var elementorSettingKey = this.resolveInlineSettingKey($element),
                        settingKey = elementorSettingKey,
                        keyParts,
                        isRepeaterKey,
                        settingsModel = this.view.getEditModel().get('settings');

                    if (!elementorSettingKey) {
                        return;
                    }
                    ...
                    var elementDataToolbar = this.resolveInlineToolbar($element),
                ...
                stopEditing: function stopEditing() {
                     ...
                     */
                    if ('advanced' === this.resolveInlineToolbar(this.$currentEditingArea)) {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsElementsView = Marionette.CollectionView.extend({
                ...
                id: 'drupal_layoutbuilder-panel-elements',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelMenuPageView = Marionette.CompositeView.extend({
                id: 'drupal_layoutbuilder-panel-page-menu',

                template: '#tmpl-drupal_layoutbuilder-panel-menu',

                childView: PanelMenuGroupView,

                childViewContainer: '#drupal_layoutbuilder-panel-page-menu-content',
                ...
                initGroups: function initGroups() {
                    ...
                    if (elementor.config.user.is_administrator) {
                        menus = [{
                            ...
                            items: [{
                                name: 'drupal_layoutbuilder-settings',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.CompositeView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-menu-group',

                className: 'drupal_layoutbuilder-panel-menu-group',

                childView: PanelMenuItemView,

                childViewContainer: '.drupal_layoutbuilder-panel-menu-items',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-menu-item',

                className: 'drupal_layoutbuilder-panel-menu-item',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Module.extend({
                ...
                parseTagsText: function parseTagsText(text, settings, parseCallback) {
                    ...
                    return text.replace(/\[drupal_layoutbuilder-tag[^\]]+]/g, function (tagText) {
                ...
                tagDataToTagText: function tagDataToTagText(tagID, tagName, tagSettings) {
                    ...
                    return '[drupal_layoutbuilder-tag id="' + tagID + '" name="' + tagName + '" settings="' + tagSettings + '"]';
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                ...
                className: function className() {
                    return 'drupal_layoutbuilder-tag';
                },
                ...
                getTemplate: function getTemplate() {
                    ...
                    return Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-tag-' + this.getOption('name') + '-content');
                },
                ...
                onRender: function onRender() {
                    this.el.id = 'drupal_layoutbuilder-tag-' + this.getOption('id');
                }
            });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = ControlsStack.extend({
                id: function id() {
                    return 'drupal_layoutbuilder-panel-' + this.getOption('name') + '-settings';
                },

                getTemplate: function getTemplate() {
                    return '#tmpl-drupal_layoutbuilder-panel-' + this.getOption('name') + '-settings';
                },

                childViewContainer: function childViewContainer() {
                    return '#drupal_layoutbuilder-panel-' + this.getOption('name') + '-settings-controls';
                },
            ...
            module.exports = Module.extend({
                initToast: function initToast() {
                    var toast = elementor.dialogsManager.createWidget('buttons', {
                        id: 'drupal_layoutbuilder-toast',
                        position: {
                            my: 'center bottom',
                            at: 'center bottom-10',
                            of: '#drupal_layoutbuilder-panel-content-wrapper',
                            autoRefresh: true
                        },
                        hide: {
                            onClick: true,
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelLayoutView = Marionette.LayoutView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel',

                id: 'drupal_layoutbuilder-panel-inner',

                regions: {
                    content: '#drupal_layoutbuilder-panel-content-wrapper',
                    header: '#drupal_layoutbuilder-panel-header-wrapper',
                    footer: '#drupal_layoutbuilder-panel-footer',
                    modeSwitcher: '#drupal_layoutbuilder-mode-switcher'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            EditModeItemView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-mode-switcher-content',

                id: 'drupal_layoutbuilder-mode-switcher-inner',

                ui: {
                    previewButton: '#drupal_layoutbuilder-mode-switcher-preview-input',
                    previewLabel: '#drupal_layoutbuilder-mode-switcher-preview',
                    previewLabelA11y: '#drupal_layoutbuilder-mode-switcher-preview .drupal_layoutbuilder-screen-only'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsLayoutView = Marionette.LayoutView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-elements',
                ...
                regions: {
                    elements: '#drupal_layoutbuilder-panel-elements-wrapper',
                    search: '#drupal_layoutbuilder-panel-elements-search-area'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsCategoriesView = Marionette.CompositeView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-categories',

                childView: PanelElementsCategoryView,

                childViewContainer: '#drupal_layoutbuilder-panel-categories',

                id: 'drupal_layoutbuilder-panel-elements-categories',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsCategoryView = Marionette.CompositeView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-elements-category',

                className: 'drupal_layoutbuilder-panel-category',

                ui: {
                    title: '.drupal_layoutbuilder-panel-category-title',
                    items: '.drupal_layoutbuilder-panel-category-items'
                },
                ...
                id: function id() {
                    return 'drupal_layoutbuilder-panel-category-' + this.model.get('name');
                },

                childView: __webpack_require__(39),

                childViewContainer: '.drupal_layoutbuilder-panel-category-items',
                ...
                onRender: function onRender() {
                    ...
                    if (isActive) {
                        this.$el.addClass('drupal_layoutbuilder-active');
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelElementsSearchView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-element-search',

                id: 'drupal_layoutbuilder-panel-elements-search-wrapper',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            EditorView = ControlsStack.extend({
                ...
                id: 'drupal_layoutbuilder-panel-page-editor',

                childViewContainer: '#drupal_layoutbuilder-controls',
                ...
                onDestroy: function onDestroy() {
                    ...
                    if (editedElementView) {
                        editedElementView.$el.removeClass('drupal_layoutbuilder-element-editable');
                    }
                ...
                onRender: function onRender() {
                    ...
                    if (editedElementView) {
                        editedElementView.$el.addClass('drupal_layoutbuilder-element-editable');
                    }
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeColorView = PanelSchemeItemView.extend({
                ...
                ui: {
                    input: '.drupal_layoutbuilder-panel-scheme-color-value'
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeTypographyView = PanelSchemeItemView.extend({
                ...
                className: function className() {
                    ...
                    return classes + ' drupal_layoutbuilder-panel-box';
                },

                ui: {
                    heading: '.drupal_layoutbuilder-panel-heading',
                    allFields: '.drupal_layoutbuilder-panel-scheme-typography-item-field',
                    inputFields: 'input.drupal_layoutbuilder-panel-scheme-typography-item-field',
                    selectFields: 'select.drupal_layoutbuilder-panel-scheme-typography-item-field',
                    selectFamilyFields: 'select.drupal_layoutbuilder-panel-scheme-typography-item-field[name="font_family"]'
                },
                ...
                toggleVisibility: function toggleVisibility() {
                    this.$el.toggleClass('drupal_layoutbuilder-open');
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelSchemeDisabledView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-schemes-disabled',

                id: 'drupal_layoutbuilder-panel-schemes-disabled',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-footer-content',

                tagName: 'nav',

                id: 'drupal_layoutbuilder-panel-footer-tools',

                possibleRotateModes: ['portrait', 'landscape'],

                ui: {
                    buttonSave: '#drupal_layoutbuilder-panel-saver-button-publish, #drupal_layoutbuilder-panel-saver-menu-save-draft', // TODO: remove. Compatibility for Pro <= 1.9.5
                    menuButtons: '.drupal_layoutbuilder-panel-footer-tool',
                    settings: '#drupal_layoutbuilder-panel-footer-settings',
                    deviceModeIcon: '#drupal_layoutbuilder-panel-footer-responsive > i',
                    deviceModeButtons: '#drupal_layoutbuilder-panel-footer-responsive .drupal_layoutbuilder-panel-footer-sub-menu-item',
                    saveTemplate: '#drupal_layoutbuilder-panel-saver-menu-save-template',
                    history: '#drupal_layoutbuilder-panel-footer-history',
                    navigator: '#drupal_layoutbuilder-panel-footer-navigator'
                },
                ...
                onMenuButtonsClick: function onMenuButtonsClick(event) {
                    ...
                    if (!$tool.hasClass('drupal_layoutbuilder-toggle-state') || jQuery(event.target).closest('.drupal_layoutbuilder-panel-footer-sub-menu-item').length) {
                        return;
                    }

                    var isOpen = $tool.hasClass('drupal_layoutbuilder-open');

                    this.ui.menuButtons.not('.drupal_layoutbuilder-leave-open').removeClass('drupal_layoutbuilder-open');

                    if (!isOpen) {
                        $tool.addClass('drupal_layoutbuilder-open');
                    }
                },
                ...
                onSettingsClick: function onSettingsClick() {
                    ...
                    if ('page_settings' !== elementor.getPanelView().getCurrentPageName()) {
                        ...
                        elementor.getPanelView().getCurrentPageView().once('destroy', function () {
                            self.ui.settings.removeClass('drupal_layoutbuilder-open');
                        });
                    }
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            PanelHeaderItemView = Marionette.ItemView.extend({
                template: '#tmpl-drupal_layoutbuilder-panel-header',

                id: 'drupal_layoutbuilder-panel-header',

                ui: {
                    menuButton: '#drupal_layoutbuilder-panel-header-menu-button',
                    menuIcon: '#drupal_layoutbuilder-panel-header-menu-button i',
                    title: '#drupal_layoutbuilder-panel-header-title',
                    addButton: '#drupal_layoutbuilder-panel-header-add-button'
                },
                ...
                onRender: function onRender() {
                    var existing = this.ui.title.find('.drupal_layoutbuilder-panel-header-title-text').text();
                    this.setTitle(existing.trim() || 'Drupal Layout Builder');
                },

                setTitle: function setTitle(title) {
                    var version = window.drupalLayoutbuilderModuleVersion || '';
                    var versionMarkup = version ? ' <span class="drupal_layoutbuilder-panel-header-title-version">v' + version + '</span>' : '';
                    this.ui.title.html('<span class="drupal_layoutbuilder-panel-header-title-text">' + title + '</span><br>' + versionMarkup);
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            Preview = BaseSectionsContainerView.extend({
                template: Marionette.TemplateCache.get('#tmpl-drupal_layoutbuilder-preview'),

                className: 'drupal_layoutbuilder-inner',

                childViewContainer: '.drupal_layoutbuilder-section-wrap',
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var AddSectionView = function (_BaseAddSectionView) {
                ...
                _createClass(AddSectionView, [{
                    ...
                    key: 'id',
                    get: function get() {
                        return 'drupal_layoutbuilder-add-new-section';
                    }
                }]);
        ...
        (function (module, exports, __webpack_require__) {
            ...
            BaseSectionsContainerView = BaseContainer.extend({
                ...
                getSortableOptions: function getSortableOptions() {
                    return {
                        handle: '> .drupal_layoutbuilder-element-overlay .drupal_layoutbuilder-editor-element-edit',
                        items: '> .drupal_layoutbuilder-section'
                    };
                },
        ...
        (function (module, exports, __webpack_require__) {
            ...
            module.exports = Marionette.Behavior.extend({
                ...
                ui: {
                    editButton: '.drupal_layoutbuilder-editor-element-edit'
                },
                    ...
                    this.getDialog = function () {
                        if (!dialog) {
                            dialog = elementor.dialogsManager.createWidget('buttons', {
                                className: 'drupal_layoutbuilder-introduction',
                            ...
                            dialog.getElements('ok').addClass('drupal_layoutbuilder-button drupal_layoutbuilder-button-success');
                        }
    ...
    (function($){
        ...
        function populateFields(contentType, savedValues, $scope, forceReload = false) {
            if (!contentType) return;

            $.ajax({
            url: '/drupal-layoutbuilder/fields/' + contentType,
            method: 'GET',
            dataType: 'json',
            success: function(fields){
                ...
                $.each(mapping, function(controlName, dataSetting){
                var $select = $scope.find('select[data-setting="' + dataSetting + '"]');
                if (!$select.length) return;

                var savedVal = savedValues[dataSetting] || $select.val();

                if ($select.children().length <= 1 || forceReload) {
                    $select.empty();

                
                    var $noneOpt = $('<option>').attr('value', '').text('None');
                    if (!savedVal) $noneOpt.prop('selected', true);
                    $select.append($noneOpt);

                    $.each(fields, function(value, label){
                    var $opt = $('<option>').attr('value', value).text(label);
                    if (savedVal && value === savedVal) {
        ...
        function initContentTypeControls($scope, model) {
            var $contentTypeSelect = $scope.find('select[data-setting="content_type"]');
            var contentType = $contentTypeSelect.val();

            if (contentType) {
            var savedValues = {
                field_title: model.getSetting('field_title'),
                field_body: model.getSetting('field_body'),
                field_image: model.getSetting('field_image')
            };
            populateFields(contentType, savedValues, $scope, true);
            }

            $scope.off('change.elementorContentType')
            .on('change.elementorContentType', 'select[data-setting="content_type"]', function(){
                populateFields($(this).val(), {}, $scope, true);
            });
        }

        elementor.hooks.addAction('panel/open_editor/widget', function(panel, model){
            initContentTypeControls(panel.$el, model);
            ...
            var contentType = panel.$el.find('select[data-setting="content_type"]').val();
            if (contentType) {
                populateFields(contentType, savedValues, panel.$el, false); // no force reload
            }
            });
        });
    ...
    (function($) {
        elementor.hooks.addAction('panel/open_editor/widget/drupal-block', function(panel, model, view) {
            function updateDrupalBlockData() {
                const contentType = model.getSetting('content_type');
                const titleField  = model.getSetting('field_title');
                const bodyField   = model.getSetting('field_body');
                const imageField  = model.getSetting('field_image');
                const nodeField   = model.getSetting('node_columns');
                const nodeOffset  = model.getSetting('node_offset');
                const nodeSearch  = model.getSetting('node_search');
                ...
                $.get(`/drupal-layoutbuilder/drupal-block-data/${contentType}`, {
                    title_field: titleField,
                    body_field: bodyField,
                    image_field: imageField,
                    node_columns: nodeField,
                    node_offset: nodeOffset,
                    node_search: nodeSearch
                })
                .done(function(data) {
                    model.setSetting('drupal_block_data', data);
                    model.trigger('change:drupal_block_data', model, data);
                })
                .fail(function(xhr, status, err) {
                    console.error("Failed to fetch drupal_block_data:", status, err, xhr.responseText);
                });
            }

            const debouncedUpdate = _.debounce(updateDrupalBlockData, 200);

            updateDrupalBlockData();
            ...
            settingsToWatch.forEach(setting => {
                model.off(`change:${setting}.drupalBlock`).on(`change:${setting}.drupalBlock`, () => {
                    setTimeout(debouncedUpdate, 0);
                });
            });

            panel.$el
                .find('select[data-setting], input[data-setting], textarea[data-setting]')
                .off('.drupalBlock')
                .on('input.drupalBlock change.drupalBlock', function() {
    ...
    (function($) {
        elementor.hooks.addAction('panel/open_editor/widget/drupal-webform', function(panel, model, view) {
            function updateWebformFields() {
                const webformId = model.getSetting('webform_id');
                if (!webformId) {
                    model.setSetting('field_select_webform', '');
                    model.setSetting('webform_ajax_conditions', '');
                    return;
                }
                // Fetch field data
                $.get(`/drupal-layoutbuilder/webform-fields-json/${webformId}`)
                    .done(function(data) {
                        model.setSetting('field_select_webform', data);
                        model.trigger('change:field_select_webform', model, data);
                    })
                    .fail(function(err) {
                        console.error("Failed to fetch field_select_webform:", err);
                    });
                // Fetch AJAX conditions
                $.get(`/drupal-layoutbuilder/webform-ajax-conditions/${webformId}`)
                    .done(function(data) {
                    console.log("AJAX Conditions:", data);
                    model.setSetting('webform_ajax_conditions', data.conditions);
                    model.trigger('change:webform_ajax_conditions', model, data.conditions);
                    })
                    .fail(function(err) {
                    console.error("Failed to fetch webform ajax conditions:", err);
                    });
            }

            const debouncedUpdate = _.debounce(updateWebformFields, 200);

            // Initial call when editor opens
            updateWebformFields();
            model.off('change:webform_id.drupalWebform').on('change:webform_id.drupalWebform', () => {
                setTimeout(debouncedUpdate, 0);
            });
            panel.$el
                .find('select[data-setting="webform_id"]')
                .off('.drupalWebform')
                .on('change.drupalWebform', function() {
                    const value = $(this).val();
                    model.setSetting('webform_id', value);
                    debouncedUpdate();
                });
        });
    })(jQuery);
    // Drupal Custom Library For MEDIA
    (function ($) {
    $(window).on('load', function () {
        elementor.hooks.addAction('panel/open_editor/widget', function (panel, model) {

        function renderMediaBox(fileUrl) {
            if (fileUrl) {
            return (
                '<div class="drupal-media-select-area select-drupal-media">' +
                '<img class="drupal-media-preview" src="' + fileUrl + '" />' +
                '<div class="drupal-media-overlay">' +
                '<i class="eicon-edit"></i><span>Change File</span>' +
                '</div>' +
                '</div>' +
                '<div class="drupal-media-delete"><i class="eicon-trash"></i></div>'
            );
            } else {
            return (
                '<div class="drupal-media-select-area select-drupal-media">' +
        ...
        panel.$el
            .off('click.elementorFile', '.select-drupal-media')
            .on('click.elementorFile', '.select-drupal-media', function (e) {
            e.preventDefault();

            var popup = window.open(
                '/drupal-layoutbuilder/file-browser',
                'fileBrowser',
                'width=700,height=400,resizable=yes,scrollbars=yes'
            );

            var $control = $(this).closest('.drupal_layoutbuilder-control');
            var $input = $control.find('input[data-setting]');
            var $box = $control.find('.drupal-media-box');
            var controlName = $input.data('setting');

            var onMessage = function (event) {
                if (!event.data || (event.data.type !== 'file-selected' && event.data.type !== 'media-selected')) return;
                ...
                // update model + input
                $input.val(fileId).trigger('input');
                model.setSetting(controlName, { id: fileId, url: fileUrl });
                model.trigger('change:' + controlName, model);
                elementor.channels.data.trigger('elementor:preview:render', { model: model });

                setTimeout(() => {
                const iframe = document.querySelector('#drupal_layoutbuilder-preview-iframe');
                if (iframe && iframe.contentDocument) {
                    const doc = iframe.contentDocument;
                    const id = model.get('id');
                    const $el = $(doc).find('.drupal_layoutbuilder-element-' + id + ' > .drupal_layoutbuilder-widget-containe');
                    $el.css({
                ...
                // update UI
                $box.html(renderMediaBox(fileUrl));
        ...
        // --- Delete image ---
        panel.$el
            .off('click.elementorFileDelete', '.drupal-media-delete')
            .on('click.elementorFileDelete', '.drupal-media-delete', function (e) {
            e.preventDefault();
            ...
            model.setSetting(controlName, { id: '', url: '' });
            model.trigger('change:' + controlName, model);
            elementor.channels.data.trigger('elementor:preview:render', { model: model });
    ...
    // Drupal Custom Library For GALLERY
    (function ($) {
    $(window).on("load", function () {
        elementor.hooks.addAction("panel/open_editor/widget", function (panel, model) {

        function getCurrentImages($input) {
            try {
        ...
        function renderGallery(images) {
            ...
            <div class="drupal-gallery-thumbs">
                ...
                .map(
                    (img, index) => `
                    <div class="drupal-gallery-thumb" data-id="${img.id}" data-index="${index}">
                        <img src="${img.url}" alt="">
                    </div>`
                )
                .join("")}
        ...
        function updateGallery($control, controlName, files) {
            const $input = $control.find("input[data-setting]");
            const $container = $control.find(".drupal-gallery-container");

            $input.val(JSON.stringify(files)).trigger("input");
            model.setSetting(controlName, files);
            model.trigger("change:" + controlName, model);

            elementor.channels.data.trigger("elementor:preview:render", { model });
            $container.html(renderGallery(files));
        }

        panel.$el
            .off("click.elementorGallery", ".select-drupal-gallery")
            .on("click.elementorGallery", ".select-drupal-gallery", function (e) {
            e.preventDefault();

            const $control = $(this).closest(".drupal-gallery-control");
            const $input = $control.find("input[data-setting]");
            const controlName = $input.data("setting");
            if (!controlName) return;

            const current = getCurrentImages($input);

            // pass current selected images to popup
            const popup = window.open(
                "/drupal-layoutbuilder/gallery-browser?selected=" +
            ...
            const onMessage = function (event) {
                if (!event.data || event.data.type !== "files-selected") return;
                window.removeEventListener("message", onMessage);

                const files = event.data.files || [];
                updateGallery($control, controlName, files);
        ...
        // 🗑 Clear All
        panel.$el
            .off("click.elementorGalleryClear", ".clear-drupal-gallery")
            .on("click.elementorGalleryClear", ".clear-drupal-gallery", function (e) {
            e.preventDefault();
            ...
            updateGallery($control, controlName, []);
            });
        });
    });
    })(jQuery);
