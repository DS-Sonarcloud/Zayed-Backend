...
class Widget_Menu_Anchor extends Widget_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'Menu Anchor', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_anchor',
			[
				'label' => ___layoutbridge_adapter( 'Anchor', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'anchor_description',
			[
				'raw' => ___layoutbridge_adapter( 'This ID will be the CSS ID you will have to use in your own page, Without #.', 'elementor' ),
		...
		$this->add_control(
			'anchor',
			[
				'label' => ___layoutbridge_adapter( 'The ID of Menu Anchor.', 'elementor' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => ___layoutbridge_adapter( 'For Example: About', 'elementor' ),
				'label_block' => true,
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'inner', 'class', 'drupal_layoutbuilder-menu-anchor' );
		?>
	...
	protected function _content_template() {
		?>
		<div class="drupal_layoutbuilder-menu-anchor"{{{ settings.anchor ? ' id="' + settings.anchor + '"' : '' }}}></div>
		<?php
	}
}
