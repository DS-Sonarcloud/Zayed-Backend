...
class Widget_Sidebar extends Widget_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'Sidebar', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! $wp_registered_sidebars ) {
			$options[''] = ___layoutbridge_adapter( 'No sidebars were found', 'elementor' );
		} else {
			$options[''] = ___layoutbridge_adapter( 'Choose Sidebar', 'elementor' );
		...
		$this->start_controls_section(
			'section_sidebar',
			[
				'label' => ___layoutbridge_adapter( 'Sidebar', 'elementor' ),
			]
		);

		$this->add_control( 'sidebar', [
			'label' => ___layoutbridge_adapter( 'Choose Sidebar', 'elementor' ),
