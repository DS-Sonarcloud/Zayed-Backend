...
class Widget_Html extends Widget_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'HTML', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => ___layoutbridge_adapter( 'HTML Code', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'placeholder' => ___layoutbridge_adapter( 'Enter your code', 'elementor' ),
				'show_label' => false,
			]
		);
