...
class Widget_Spacer extends Widget_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'Spacer', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_spacer',
			[
				'label' => ___layoutbridge_adapter( 'Spacer', 'elementor' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drupal_layoutbuilder-spacer-inner' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		?>
		<div class="drupal_layoutbuilder-spacer">
			<div class="drupal_layoutbuilder-spacer-inner"></div>
		</div>
		<?php
	}
