...
class Widget_Audio extends Widget_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'SoundCloud', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_audio',
			[
				'label' => ___layoutbridge_adapter( 'SoundCloud', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'visual',
			[
				'label' => ___layoutbridge_adapter( 'Visual Player', 'elementor' ),
		...
		*/
		...
		$this->add_control(
			'sc_buying',
			[
				'label' => ___layoutbridge_adapter( 'Buy Button', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'sc_liking',
			[
				'label' => ___layoutbridge_adapter( 'Like Button', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_show_artwork',
			[
				'label' => ___layoutbridge_adapter( 'Artwork', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_sharing',
			[
				'label' => ___layoutbridge_adapter( 'Share Button', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_show_comments',
			[
				'label' => ___layoutbridge_adapter( 'Comments', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_show_playcount',
			[
				'label' => ___layoutbridge_adapter( 'Play Counts', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_show_user',
			[
				'label' => ___layoutbridge_adapter( 'Username', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => ___layoutbridge_adapter( 'Hide', 'elementor' ),
				'label_on' => ___layoutbridge_adapter( 'Show', 'elementor' ),
				'default' => 'yes',
	...
	protected function render() {
		...
		$html = wp_oembed_get_layoutbridge_adapter($settings['link']['url'], [
			'soundcloud' => [
				'params' => $params,
				'visual' => $visual,
		...
		echo '<div class="drupal_layoutbuilder-soundcloud-wrapper" data-autoplay="' . $autoPlayFlag . '">' 
			. $html 
			. '</div>';
		}
	}
	...
	*/
    ...
    if ( preg_match('/<iframe.*src="([^"]+)".*><\/iframe>/isU', $html, $matches) ) {
        $url = esc_url_layoutbridge_adapter(
            add_query_arg_layoutbridge_adapter($params, $matches[1])
        );
