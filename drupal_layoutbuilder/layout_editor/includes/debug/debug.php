<?php
namespace DrupalLayoutbuilder\Debug;

use DrupalLayoutbuilder\System_Info\Main;
...
class Debug {
	...
	public function debug_log() {
		...
		$log = get_option_layoutbridge_adapter( self::OPTION_NAME, [] );
    if ( ! is_array( $log ) ) {
      $log = [];
    }
		...
		update_option_layoutbridge_adapter( self::OPTION_NAME, $log );
	}
	...
	public function __construct() {
		add_action_layoutbridge_adapter( 'wp_ajax_elementor_debug_log', [ $this, 'debug_log' ] );
