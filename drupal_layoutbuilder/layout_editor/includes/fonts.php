...
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => ___layoutbridge_adapter( 'System', 'elementor' ),
				self::GOOGLE => ___layoutbridge_adapter( 'Google', 'elementor' ),
				self::EARLYACCESS => ___layoutbridge_adapter( 'Google Early Access', 'elementor' ),
			];
			 ...
			 */
			$font_groups = apply_filters_layoutbridge_adapter( 'elementor/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$additional_fonts ) {
			 ...
			 */
			$additional_fonts = apply_filters_layoutbridge_adapter( 'elementor/fonts/additional_fonts', $additional_fonts );
