...
class Scheme_Typography extends Scheme_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'Typography', 'elementor' );
	}
	...
	public function get_disabled_title() {
		return ___layoutbridge_adapter( 'Default Fonts', 'elementor' );
	}
	...
	public function get_scheme_titles() {
		return [
			self::TYPOGRAPHY_1 => ___layoutbridge_adapter( 'Primary Headline', 'elementor' ),
			self::TYPOGRAPHY_2 => ___layoutbridge_adapter( 'Secondary Headline', 'elementor' ),
			self::TYPOGRAPHY_3 => ___layoutbridge_adapter( 'Body Text', 'elementor' ),
			self::TYPOGRAPHY_4 => ___layoutbridge_adapter( 'Accent Text', 'elementor' ),
		];
	}
	...
	public function print_template_content() {
		?>
		<div class="drupal_layoutbuilder-panel-scheme-items"></div>
		<?php
	}
}
