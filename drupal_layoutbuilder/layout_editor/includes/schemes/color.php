...
class Scheme_Color extends Scheme_Base {
	...
	public function get_title() {
		return ___layoutbridge_adapter( 'Colors', 'elementor' );
	}
	...
	public function get_disabled_title() {
		return ___layoutbridge_adapter( 'Color Palettes', 'elementor' );
	}
	...
	public function get_scheme_titles() {
		return [
			self::COLOR_1 => ___layoutbridge_adapter( 'Primary', 'elementor' ),
			self::COLOR_2 => ___layoutbridge_adapter( 'Secondary', 'elementor' ),
			self::COLOR_3 => ___layoutbridge_adapter( 'Text', 'elementor' ),
			self::COLOR_4 => ___layoutbridge_adapter( 'Accent', 'elementor' ),
		];
	}
	...
	public function print_template_content() {
		?>
		<div class="drupal_layoutbuilder-panel-scheme-content drupal_layoutbuilder-panel-box">
			<div class="drupal_layoutbuilder-panel-heading">
				<div class="drupal_layoutbuilder-panel-heading-title"><?php echo $this->_get_current_scheme_title(); ?></div>
			</div>
			<?php
			...
			if ( $description ) :
				?>
				<div class="drupal_layoutbuilder-panel-scheme-description drupal_layoutbuilder-descriptor"><?php echo $description; ?></div>
			<?php endif; ?>
			<div class="drupal_layoutbuilder-panel-scheme-items drupal_layoutbuilder-panel-box-content"></div>
		</div>
		<div class="drupal_layoutbuilder-panel-scheme-colors-more-palettes drupal_layoutbuilder-panel-box">
			<div class="drupal_layoutbuilder-panel-heading">
				<div class="drupal_layoutbuilder-panel-heading-title"><?php echo ___layoutbridge_adapter( 'More Palettes', 'elementor' ); ?></div>
			</div>
			<div class="drupal_layoutbuilder-panel-box-content">
				<?php foreach ( $this->_get_system_schemes_to_print() as $scheme_name => $scheme ) : ?>
					<div class="drupal_layoutbuilder-panel-scheme-color-system-scheme" data-scheme-name="<?php echo esc_attr_layoutbridge_adapter( $scheme_name ); ?>">
						<div class="drupal_layoutbuilder-panel-scheme-color-system-items">
							<?php foreach ( $scheme['items'] as $color_value ) : ?>
								<div class="drupal_layoutbuilder-panel-scheme-color-system-item" style="background-color: <?php echo esc_attr_layoutbridge_adapter( $color_value ); ?>;"></div>
							<?php endforeach; ?>
						</div>
						<div class="drupal_layoutbuilder-title"><?php echo $scheme['title']; ?></div>
					</div>
				<?php endforeach; ?>
			</div>
		</div>
	...
	protected function _get_current_scheme_title() {
		return ___layoutbridge_adapter( 'Color Palette', 'elementor' );
	}
}
