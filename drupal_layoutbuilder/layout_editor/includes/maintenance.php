...
class Maintenance {
	...
	public static function activation( $network_wide ) {
		...
		set_transient_layoutbridge_adapter( 'elementor_activation_redirect', true, MINUTE_IN_SECONDS );
	}
	...
	public static function init() {
		register_activation_hook_layoutbridge_adapter( DRUPAL_LAYOUTBUILDER_PLUGIN_BASE, [ __CLASS__, 'activation' ] );
		register_uninstall_hook_layoutbridge_adapter( DRUPAL_LAYOUTBUILDER_PLUGIN_BASE, [ __CLASS__, 'uninstall' ] );
	}
}
