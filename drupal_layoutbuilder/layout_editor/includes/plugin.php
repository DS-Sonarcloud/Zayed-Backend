...
use DrupalLayoutbuilder\Core\Ajax_Manager;
use DrupalLayoutbuilder\Core\Debug\Inspector;
use DrupalLayoutbuilder\Core\Documents_Manager;
use DrupalLayoutbuilder\Core\Files\Manager as Files_Manager;
use DrupalLayoutbuilder\Core\Modules_Manager;
use DrupalLayoutbuilder\Debug\Debug;
use DrupalLayoutbuilder\Core\Settings\Manager as Settings_Manager;
use DrupalLayoutbuilder\Core\Settings\Page\Manager as Page_Settings_Manager;
use DrupalLayoutbuilder\Modules\History\Revisions_Manager;
use DrupalLayoutbuilder\Core\DynamicTags\Manager as Dynamic_Tags_Manager;
...
class Plugin {
	 ...
	 * @access public
	 *
	 * @var \DrupalLayoutbuilder\Core\RoleManager\Role_Manager
	 */
	public $role_manager;
	...
	/**
	 * Drupal widgets manager.
	 *
	 * Holds the Drupal widgets manager.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function __clone() {
		...
		_doing_it_wrong_layoutbridge_adapter( __FUNCTION__, esc_html___layoutbridge_adapter( 'Something went wrong.', 'elementor' ), '1.0.0' );
	}
	...
	public static function instance() {
		if ( is_null( self::$instance ) ) {
			 ...
			 * @since 1.0.0
			 */
			do_action_layoutbridge_adapter( 'elementor/loaded' );
		}
	 ...
	 * Init.
	 *
	 * Initialize Drupal Layoutbuilder Plugin. Register Drupal Layoutbuilder support for all the
	...
	public function init() {
		 ...
		 * @since 1.0.0
		 */
		do_action_layoutbridge_adapter( 'elementor/init' );
	}
    ...
    $cpt_support = get_option_layoutbridge_adapter('elementor_cpt_support', ['page', 'post']);
  
    foreach ((array) $cpt_support as $cpt_slug) {
      add_post_type_support_layoutbridge_adapter($cpt_slug, 'elementor');
    }
  }
	...
	private function register_autoloader() {
		require DRUPAL_LAYOUTBUILDER_PATH . '/includes/autoloader.php';
	 ...
	 * Plugin constructor.
	 *
	 * Initializing Drupal Layoutbuilder plugin.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	private function __construct() {
		...
		add_action_layoutbridge_adapter( 'init', [ $this, 'init' ], 0 );
	}
}
