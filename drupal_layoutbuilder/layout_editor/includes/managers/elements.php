...
class Elements_Manager {
	...
	public function ajax_save_builder( $request ) {
		 ...
		 */
		$return_data = apply_filters_deprecated_layoutbridge_adapter( 'elementor/ajax_save_builder/return_data', [ $return_data, $request['editor_post_id'] ], '2.0.0', 'elementor/documents/ajax_save/return_data' );
	...
	private function init_elements() {
		 ...
		 * @since 1.0.0
		 */
		do_action_layoutbridge_adapter( 'elementor/elements/elements_registered' );
	}
	...
	private function init_categories() {
		$this->categories = [
			'basic' => [
				'title' => ___layoutbridge_adapter( 'Basic', 'elementor' ),
				'icon' => 'eicon-font',
			],
			'pro-elements' => [
				'title' => ___layoutbridge_adapter( 'Pro', 'elementor' ),
			],
			'general' => [
				'title' => ___layoutbridge_adapter( 'General', 'elementor' ),
				'icon' => 'eicon-font',
			],
			'theme-elements' => [
				'title' => ___layoutbridge_adapter( 'Site', 'elementor' ),
				'active' => false,
			],
			'woocommerce-elements' => [
				'title' => ___layoutbridge_adapter( 'WooCommerce', 'elementor' ),
				'active' => false,
			],
		];
		 ...
		 *
		 * Fires after basic categories are registered, before Drupal
		 ...
		 */
		do_action_layoutbridge_adapter( 'elementor/elements/categories_registered', $this );

		$this->categories['pojo'] = [
			'title' => ___layoutbridge_adapter( 'Pojo Themes', 'elementor' ),
			'icon' => 'eicon-pojome',
		];

		$this->categories['wordpress'] = [
			'title' => ___layoutbridge_adapter( 'WordPress', 'elementor' ),
	...
	private function require_files() {
		require_once DRUPAL_LAYOUTBUILDER_PATH . 'includes/base/element-base.php';

		require DRUPAL_LAYOUTBUILDER_PATH . 'includes/elements/column.php';
		require DRUPAL_LAYOUTBUILDER_PATH . 'includes/elements/section.php';
		require DRUPAL_LAYOUTBUILDER_PATH . 'includes/elements/repeater.php';
	}
}
