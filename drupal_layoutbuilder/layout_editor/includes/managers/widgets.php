...
class Widgets_Manager {
	 ...
	 * and register each Elementor and Drupal widget.
	 *
	 * @since 2.0.0
	 * @access private
	*/
	private function init_widgets() {
		...
		foreach ( $build_widgets_filename as $widget_filename ) {
			include( DRUPAL_LAYOUTBUILDER_PATH . 'includes/widgets/' . $widget_filename . '.php' );
		 ...
		 */
		do_action_layoutbridge_adapter( 'elementor/widgets/widgets_registered', $this );
	}

	/**
	 * Register Drupal widgets.
	 *
	 * Add native Drupal widget to the list of registered widget types.
	 *
	...
	*/
	private function register_wp_widgets() {
		 ...
		 */
		$black_list = apply_filters_layoutbridge_adapter( 'elementor/widgets/black_list', $black_list );
	...
	*/
	private function require_files() {
		require DRUPAL_LAYOUTBUILDER_PATH . 'includes/base/widget-base.php';
	}
