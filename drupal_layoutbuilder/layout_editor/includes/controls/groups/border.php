...
class Group_Control_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['border'] = [
			'label' => _x_layoutbridge_adapter( 'Border Type', 'Border Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => ___layoutbridge_adapter( 'None', 'elementor' ),
				'solid' => _x_layoutbridge_adapter( 'Solid', 'Border Control', 'elementor' ),
				'double' => _x_layoutbridge_adapter( 'Double', 'Border Control', 'elementor' ),
				'dotted' => _x_layoutbridge_adapter( 'Dotted', 'Border Control', 'elementor' ),
				'dashed' => _x_layoutbridge_adapter( 'Dashed', 'Border Control', 'elementor' ),
				'groove' => _x_layoutbridge_adapter( 'Groove', 'Border Control', 'elementor' ),
			],
			'selectors' => [
		...
		$fields['width'] = [
			'label' => _x_layoutbridge_adapter( 'Width', 'Border Control', 'elementor' ),
		...
		$fields['color'] = [
			'label' => _x_layoutbridge_adapter( 'Color', 'Border Control', 'elementor' ),
