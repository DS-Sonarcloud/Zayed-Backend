...
class Group_Control_Text_Shadow extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['text_shadow'] = [
			'label' => _x_layoutbridge_adapter( 'Text Shadow', 'Text Shadow Control', 'elementor' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x_layoutbridge_adapter( 'Text Shadow', 'Text Shadow Control', 'elementor' ),
