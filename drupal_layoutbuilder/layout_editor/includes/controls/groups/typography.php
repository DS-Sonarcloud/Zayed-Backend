...
class Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => _x_layoutbridge_adapter( 'Family', 'Typography Control', 'elementor' ),
		...
		$fields['font_size'] = [
			'label' => _x_layoutbridge_adapter( 'Size', 'Typography Control', 'elementor' ),
		...
		$fields['font_weight'] = [
			'label' => _x_layoutbridge_adapter( 'Weight', 'Typography Control', 'elementor' ),
		...
		$fields['text_transform'] = [
			'label' => _x_layoutbridge_adapter( 'Transform', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => ___layoutbridge_adapter( 'Default', 'elementor' ),
				'uppercase' => _x_layoutbridge_adapter( 'Uppercase', 'Typography Control', 'elementor' ),
				'lowercase' => _x_layoutbridge_adapter( 'Lowercase', 'Typography Control', 'elementor' ),
				'capitalize' => _x_layoutbridge_adapter( 'Capitalize', 'Typography Control', 'elementor' ),
				'none' => _x_layoutbridge_adapter( 'Normal', 'Typography Control', 'elementor' ),
			],
		];

		$fields['font_style'] = [
			'label' => _x_layoutbridge_adapter( 'Style', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => ___layoutbridge_adapter( 'Default', 'elementor' ),
				'normal' => _x_layoutbridge_adapter( 'Normal', 'Typography Control', 'elementor' ),
				'italic' => _x_layoutbridge_adapter( 'Italic', 'Typography Control', 'elementor' ),
				// 'oblique' => _x_layoutbridge_adapter( 'Oblique', 'Typography Control', 'elementor' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => _x_layoutbridge_adapter( 'Decoration', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => ___layoutbridge_adapter( 'Default', 'elementor' ),
				'underline' => _x_layoutbridge_adapter( 'Underline', 'Typography Control', 'elementor' ),
				'overline' => _x_layoutbridge_adapter( 'Overline', 'Typography Control', 'elementor' ),
				'line-through' => _x_layoutbridge_adapter( 'Line Through', 'Typography Control', 'elementor' ),
				'none' => _x_layoutbridge_adapter( 'None', 'Typography Control', 'elementor' ),
			],
		];

		$fields['line_height'] = [
			'label' => _x_layoutbridge_adapter( 'Line-Height', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => _x_layoutbridge_adapter( 'Letter Spacing', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => -5,
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x_layoutbridge_adapter( 'Typography', 'Typography Control', 'elementor' ),
			],
		];
	}
}
