...
class Group_Control_Box_Shadow extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['box_shadow'] = [
			'label' => _x_layoutbridge_adapter( 'Box Shadow', 'Box Shadow Control', 'elementor' ),
		...
		$controls['box_shadow_position'] = [
			'label' => _x_layoutbridge_adapter( 'Position', 'Box Shadow Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				' ' => _x_layoutbridge_adapter( 'Outline', 'Box Shadow Control', 'elementor' ),
				'inset' => _x_layoutbridge_adapter( 'Inset', 'Box Shadow Control', 'elementor' ),
			],
			'condition' => [
				'box_shadow_type!' => '',
			],
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x_layoutbridge_adapter( 'Box Shadow', 'Box Shadow Control', 'elementor' ),
