...
abstract class Group_Control_Base implements Group_Control_Interface {
	...
	public function get_base_group_classes() {
		return 'drupal_layoutbuilder-group-control-' . static::get_type() . ' drupal_layoutbuilder-group-control';
	}
	...
	protected function add_group_args_to_field( $control_id, $field_args ) {
		...
		$field_args['classes'] = $this->get_base_group_classes() . ' drupal_layoutbuilder-group-control-' . $control_id;
