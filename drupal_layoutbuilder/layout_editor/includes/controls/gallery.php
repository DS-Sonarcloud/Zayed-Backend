 ...
 *
 * A base control for creating gallery chooser control. Based on the Drupal
 * media library galleries. Used to select images from the Drupal media library.
 *
 * @since 1.0.0
 */
	...
	public function content_template() {
		...
		<div class="drupal_layoutbuilder-control-field">
			...
			<div class="drupal_layoutbuilder-control-input-wrapper">
				...
				<# } #>
				<div class="drupal_layoutbuilder-control-media drupal_layoutbuilder-control-tag-area">
					<div class="drupal_layoutbuilder-control-gallery-status">
						<span class="drupal_layoutbuilder-control-gallery-status-title"></span>
						<span class="drupal_layoutbuilder-control-gallery-clear">(<?php echo ___layoutbridge_adapter( 'Clear', 'elementor' ); ?>)</span>
					</div>
					<div class="drupal_layoutbuilder-control-gallery-thumbnails"></div>
					<button class="drupal_layoutbuilder-button drupal_layoutbuilder-control-gallery-add"><?php echo ___layoutbridge_adapter( 'Add Images', 'elementor' ); ?></button>
				</div>
			</div>
		</div>
		<?php
