...
class Control_Repeater extends Base_Data_Control {
	...
	public function content_template() {
		?>
		<label>
			<span class="drupal_layoutbuilder-control-title">{{{ data.label }}}</span>
		</label>
		<div class="drupal_layoutbuilder-repeater-fields-wrapper"></div>
		<div class="drupal_layoutbuilder-button-wrapper">
			<button class="drupal_layoutbuilder-button drupal_layoutbuilder-button-default drupal_layoutbuilder-repeater-add" type="button">
				<i class="eicon-plus" aria-hidden="true"></i><?php echo ___layoutbridge_adapter( 'Add Item', 'elementor' ); ?>
			</button>
		</div>
		<?php
	}
