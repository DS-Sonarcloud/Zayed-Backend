...
abstract class Base_Control {
	...
	final public function print_template() {
		?>
		<script type="text/html" id="tmpl-drupal_layoutbuilder-control-<?php echo esc_attr_layoutbridge_adapter( $this->get_type() ); ?>-content">
			<div class="drupal_layoutbuilder-control-content">
