...
class Control_Section extends Base_UI_Control {
	...
	public function content_template() {
		...
		<div class="drupal_layoutbuilder-panel-heading">
			<div class="drupal_layoutbuilder-panel-heading-toggle drupal_layoutbuilder-section-toggle" data-collapse_id="{{ data.name }}">
				<i class="fa" aria-hidden="true"></i>
			</div>
			<div class="drupal_layoutbuilder-panel-heading-title drupal_layoutbuilder-section-title">{{{ data.label }}}</div>
		</div>
		<?php
	}
