	...
	public function content_template() {
		...
		<div class="drupal_layoutbuilder-control-field">
			...
			<div class="drupal_layoutbuilder-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="drupal_layoutbuilder-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo ___layoutbridge_adapter( 'Select Icon', 'elementor' ); ?>">
					<option value=""><?php echo ___layoutbridge_adapter( 'Select Icon', 'elementor' ); ?></option>
