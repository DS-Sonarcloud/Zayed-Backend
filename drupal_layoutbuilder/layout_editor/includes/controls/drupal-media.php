...
class Control_Drupal_Media extends Control_Base_Multiple
{
    ...
    <div class="drupal_layoutbuilder-control-field">
        ...
        <div class="drupal_layoutbuilder-control-input-wrapper">
            <div class="drupal-media-box drupal_layoutbuilder-control-media drupal_layoutbuilder-control-preview-area">
                ...
                <div class="drupal-media-select-area select-drupal-media">
                    <# if ( data.controlValue && data.controlValue.url ) { #>
                        ...
                        <div class="drupal-media-overlay">
                            ...
                            <span><?php echo ___layoutbridge_adapter('Change Media', 'elementor'); ?></span>
                        </div>
                    <# } else { #>
                        <div class="drupal-media-placeholder">
                            <i class="eicon-plus-circle"></i>
                            <span><?php echo ___layoutbridge_adapter('Choose from Media Library', 'elementor'); ?></span>
                        </div>
                    <# } #>
                </div>
