	...
	public function content_template() {
		...
		<div class="drupal_layoutbuilder-control-field">
			...
			<div class="drupal_layoutbuilder-control-input-wrapper">
				<textarea id="<?php echo $control_uid; ?>" rows="{{ data.rows }}" class="drupal_layoutbuilder-input-style drupal_layoutbuilder-code-editor" data-setting="{{ data.name }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
