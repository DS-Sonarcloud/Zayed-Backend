 ...
 *
 * A base control for creating WYSIWYG control. Displays a Drupal WYSIWYG
 * (TinyMCE) editor.
 *
 * @since 1.0.0
 */
class Control_Wysiwyg extends Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="drupal_layoutbuilder-control-field">
			...
			<div class="drupal_layoutbuilder-control-input-wrapper drupal_layoutbuilder-control-tag-area"></div>
		</div>
		<# if ( data.description ) { #>
