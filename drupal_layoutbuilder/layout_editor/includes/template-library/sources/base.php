...
abstract class Source_Base {
	...
	public function mark_as_favorite( $template_id, $favorite = true ) {
		$favorites_templates = $this->get_user_meta_layoutbridge_adapter( 'favorites' );
	 ...
	 */
	public function get_user_meta_layoutbridge_adapter( $item = null ) {
		if ( null === $this->user_meta ) {
			$this->user_meta = get_user_meta_layoutbridge_adapter( get_current_user_id_layoutbridge_adapter(), $this->get_user_meta_prefix(), true );
		}
	...
	public function update_user_meta( $key, $value ) {
		$meta = $this->get_user_meta_layoutbridge_adapter();

		$meta[ $key ] = $value;

		$this->user_meta = $meta;

		return update_user_meta( get_current_user_id_layoutbridge_adapter(), $this->get_user_meta_prefix(), $meta );
	}
