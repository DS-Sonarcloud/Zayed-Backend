<?php
namespace DrupalLayoutbuilder\TemplateLibrary;

use DrupalLayoutbuilder\Api;
use DrupalLayoutbuilder\Core\Settings\Manager as SettingsManager;
use DrupalLayoutbuilder\TemplateLibrary\Classes\Import_Images;
...
class Manager {
	...
	private function handle_ajax_request( $ajax_request ) {
		...
		if ( 'ajax' === $request_type ) {
			wp_send_json_success_layoutbridge_adapter( $result );
		}
