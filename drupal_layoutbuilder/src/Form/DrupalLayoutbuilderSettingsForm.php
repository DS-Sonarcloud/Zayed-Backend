...
/**
 * @file
 * Contains \Drupal\drupal_layoutbuilder\Form\DrupalLayoutbuilderSettingsForm.
 */

namespace Drupal\drupal_layoutbuilder\Form;
 ...
 */
class DrupalLayoutbuilderSettingsForm extends ConfigFormBase
{
    ...
    {
        return 'drupal_layoutbuilder_settings_form';
    }
    ...
    {
        $settings = $this->configFactory->get('drupal_layoutbuilder.settings');
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $this->config('drupal_layoutbuilder.settings')->set('node_types', $checked)->save();

        foreach ($form_state->getValues() as $key => $val) {
            if ($key != 'node_types') {
                $this->config('drupal_layoutbuilder.settings')->set($key, $val)->save();
            }
        }
