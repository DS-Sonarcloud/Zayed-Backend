...
class FileBrowserController extends ControllerBase
{
    ...
    public function popup(Request $request)
    {
        ...
        $uploadUrl = '/drupal-layoutbuilder/file-upload';
...
<body>
  ...
  <script>
    ...
    document.getElementById('uploadForm').addEventListener('submit', function(e) {
      ...
      xhr.open('POST', '/drupal-layoutbuilder/file-upload', true);
...
HTML;
    ...
    public function upload(Request $request)
    {
        ...
        if (empty($_FILES['file']) || $_FILES['file']['error'] !== UPLOAD_ERR_OK) {
            \Drupal::logger('drupal_layoutbuilder')->error('Upload failed. FILES: @files', ['@files' => print_r($_FILES, TRUE)]);
