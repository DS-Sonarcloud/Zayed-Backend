...
/**
 * @file
 * Contains \Drupal\drupal_layoutbuilder\Drupal_Ajax_Manager.
 */
...
class Drupal_Ajax_Manager extends Ajax_Manager
{
    ...
    {
        return wp_send_json_error_layoutbridge_adapter([
            'responses' => $this->response_data,
        ], $code);
    }
    ...
    {
        remove_action_layoutbridge_adapter('wp_ajax_elementor_ajax', [$this, 'handle_ajax_request']);
