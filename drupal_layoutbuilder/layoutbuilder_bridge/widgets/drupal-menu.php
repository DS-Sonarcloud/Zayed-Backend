...
class Widget_Drupal_Menu extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu > li > a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu > li > a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu ul li a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu ul li a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu ul' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu a:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu li.active > a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu ul' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .drupal_layoutbuilder-drupal-block .menu a',
            ]
        );
    ...
    protected function render()
    {
        ...
        if (empty($blocks)) {
            echo '<div class="drupal_layoutbuilder-alert">' . \t('No menus selected.') . '</div>';
            return;
        }
        ...
        $unique_id = 'drupal_layoutbuilder-drupal-block-' . $this->get_id();
        ...
        echo '<div id="' . $unique_id . '" class="drupal_layoutbuilder-drupal-block menu-style-' . $menu_style . '">';

        foreach ($blocks as $item) {
            if (empty($item['block_id'])) {
                echo '<div class="drupal_layoutbuilder-alert drupal_layoutbuilder-alert-warning">';
            ...
            try {
                ...
                if (empty($block_output)) {
                    echo '<div class="drupal_layoutbuilder-alert drupal_layoutbuilder-alert-danger">';
