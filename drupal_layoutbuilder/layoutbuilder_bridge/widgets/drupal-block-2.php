...
class Widget_Drupal_Block extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'section_block',
            [
                'label' => ___layoutbridge_adapter('Blocks', 'elementor'),
            ]
        );
        ...
        $repeater->add_control(
            'block_id',
            [
                'label' => ___layoutbridge_adapter('Select Block', 'elementor'),
        ...
        $repeater->add_control(
          'layout_type',
          [
              'label' => ___layoutbridge_adapter('Layout Type', 'elementor'),
              'type' => Controls_Manager::SELECT,
              'default' => 'list',
              'options' => $styles_list,
              'label_block' => true,
              'description' => ___layoutbridge_adapter('Select the layout type for displaying blocks.', 'elementor'),
        ...
        $repeater->add_control(
            'grid_alignment',
            [
                'label' => ___layoutbridge_adapter('Grid Alignment', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control(
            'table_info_heading',
            [
                'label' => ___layoutbridge_adapter('Table Settings', 'elementor'),
        ...
        $repeater->add_control(
            'table_sticky',
            [
                'label' => ___layoutbridge_adapter('Sticky Header', 'elementor'),
        ...
        $repeater->add_control(
            'list_type',
            [
                'label' => ___layoutbridge_adapter('List Type', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'ul' => 'Unordered List',
                    'ol' => 'Ordered List',
        ...
        $repeater->add_control(
            'grid_gap',
            [
                'label' => ___layoutbridge_adapter('Grid Gap (px)', 'elementor'),
        ...
        $repeater->add_control(
            'grid_row_class',
            [
                'label' => ___layoutbridge_adapter('Row CSS Class', 'elementor'),
        ...
        $repeater->add_control(
            'table_info_heading',
            [
                'label' => ___layoutbridge_adapter('Table Information', 'elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'layout_type' => 'table',
        ...
        $repeater->add_control(
            'table_override',
            [
                'label' => ___layoutbridge_adapter('Override Normal Sorting', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'table_sticky',
            [
                'label' => ___layoutbridge_adapter('Sticky Table Header', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'table_responsive',
            [
                'label' => ___layoutbridge_adapter('Responsive Table', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'table_caption',
            [
                'label' => ___layoutbridge_adapter('Table Caption', 'elementor'),
                'type' => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'table_summary',
            [
                'label' => ___layoutbridge_adapter('Table Summary', 'elementor'),
        ...
        $repeater->add_control(
            'grouping_heading',
            [
                'label' => ___layoutbridge_adapter('Grouping Settings', 'elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'layout_type' => 'table',
        ...
        $repeater->add_control(
            ...
            [
                'label' => ___layoutbridge_adapter('Group By Field', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'No Grouping',
                    'title' => 'Title',
        ...
        $repeater->add_control(
            ...
            [
                'label' => ___layoutbridge_adapter('Use Rendered Output for Grouping', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'columns_heading',
            [
                'label' => ___layoutbridge_adapter('Column Settings', 'elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'layout_type' => 'table',
        ...
        $repeater->add_control(
            ...
            [
                'label' => ___layoutbridge_adapter('Make Columns Sortable', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'table_default_sort',
            [
                'label' => ___layoutbridge_adapter('Default Sort Column', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'No Default Sort',
                    'title' => 'Title',
        ...
        $repeater->add_control(
            'table_sort_order',
            [
                'label' => ___layoutbridge_adapter('Default Sort Order', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' => 'Ascending',
                    'desc' => 'Descending',
        ...
        $repeater->add_control(
            'table_empty_column',
            [
                'label' => ___layoutbridge_adapter('Hide Empty Columns', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'list_wrapper_class',
            [
                'label' => ___layoutbridge_adapter('Wrapper CSS Class', 'elementor'),
                'type' => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'list_item_class',
            [
                'label' => ___layoutbridge_adapter('Item CSS Class', 'elementor'),
                'type' => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'slider_speed',
            [
                'label' => ___layoutbridge_adapter('Slide Speed (ms)', 'elementor'),
                'type' => Controls_Manager::NUMBER,
                'default' => 3000,
                'min' => 1000,
                'step' => 500,
        ...
        $repeater->add_control(
            'slider_navigation',
            [
                'label' => ___layoutbridge_adapter('Show Navigation', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'slider_pagination',
            [
                'label' => ___layoutbridge_adapter('Show Pagination', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            ...
            [
                'label' => ___layoutbridge_adapter('Row Settings', 'elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'block_id' => array_keys(array_filter($block_options, function($label, $id) {
        ...
        $repeater->add_control(
            'row_type',
            [
                'label' => ___layoutbridge_adapter('Row Plugin', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'fields' => 'Fields',
        ...
        $repeater->add_control(
            'inline_fields',
            [
                'label' => ___layoutbridge_adapter('Inline Fields', 'elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => 'Yes',
                'label_off' => 'No',
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'separator',
            [
                'label' => ___layoutbridge_adapter('Field Separator', 'elementor'),
                'type' => Controls_Manager::TEXT,
                'default' => ' | ',
                'condition' => [
                    'row_type' => 'fields',
        ...
        $repeater->add_control(
            'view_mode',
            [
                'label' => ___layoutbridge_adapter('View Mode', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'teaser' => 'Teaser',
                    'full' => 'Full Content',
        ...
        $this->add_control(
          'blocks',
          [
              'label' => ___layoutbridge_adapter('Add Blocks', 'elementor'),
        ...
        $this->start_controls_section(
            'section_style_block',
            [
                'label' => ___layoutbridge_adapter('Block Style', 'elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-drupal-block' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
          ...
          [
              ...
              'type' => Controls_Manager::COLOR,
              'selectors' => [
                  '{{WRAPPER}} .drupal_layoutbuilder-drupal-block' => 'color: {{VALUE}};',
              ],
          ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .drupal_layoutbuilder-drupal-block',
            ]
        );
    ...
    protected function render()
    {
        ...
        if (empty($blocks)) {
            echo '<div class="drupal_layoutbuilder-alert">No blocks selected.</div>';
            return;
        }

        echo '<div class="drupal_layoutbuilder-drupal-block">';
    ...
    private function render_block($block_id, $layout_type = '')
{
    ...
    if (strpos($block_id, 'views_block:') === 0) {
        ...
        if (!$view) {
            return "<div class='drupal_layoutbuilder-alert'>View not found</div>";
        }
        ...
        if ($layout_type) {
            ...
            if ($valid_style) {
                ...
                return "<div class='drupal_layoutbuilder-alert'>Invalid layout type: $layout_type</div>";
            }
        }
    ...
    try {
        ...
        return "<div class='drupal_layoutbuilder-alert'>Block error: " . $e->getMessage() . "</div>";
    }
}
    ...
    private function render_view_block($block_id, $layout_type = 'list')
    {
      ...
      if (!$view) {
          return "<div class='drupal_layoutbuilder-alert'>View not found: $view_id</div>";
      }
