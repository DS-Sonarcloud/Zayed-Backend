...
class Widget_Drupal_Block extends Widget_Base
{
    ...
    {
        return ___layoutbridge_adapter('Drupal block', 'elementor');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'content_type',
            [
                'label' => ___layoutbridge_adapter('Select Content Type', 'elementor'),
        ...
        $this->add_control(
            'field_title',
            [
                'label' => ___layoutbridge_adapter('Select Title Field', 'elementor'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'field_body',
            [
                'label' => ___layoutbridge_adapter('Select Body Field', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => ['none' => 'None'], // default empty
                'default' => 'none',
            ]
        ...
        $this->add_control(
            'field_image',
            [
                'label' => ___layoutbridge_adapter('Select Image Field', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => ['none' => 'None'], // default empty
                'default' => 'none',
        ...
        $this->add_control(
            'node_columns',
            [
                'label' => ___layoutbridge_adapter('Number of Items', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 5,
        ...
        $this->add_control(
            'node_search',
            [
                'label' => ___layoutbridge_adapter('Filter by Title', 'elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => ___layoutbridge_adapter('Enter keyword', 'elementor'),
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            'node_offset',
            [
                'label' => ___layoutbridge_adapter('Number of Items to Skip', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 0,
                'options' => $node_offset,
            ]
        ...
        $this->add_control(
            'node_columns_items',
            [
                'label' => ___layoutbridge_adapter('Number of Items in row', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 5,
                'options' => $node_columns,
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'list' => ___layoutbridge_adapter('List', 'elementor'),
                    'grid' => ___layoutbridge_adapter('Grid', 'elementor'),
                ],
                'default' => 'grid',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-title,
                    {{WRAPPER}} .drupal_layoutbuilder-item .para-heading,
                    {{WRAPPER}} .drupal_layoutbuilder-item .para-description' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .drupal_layoutbuilder-item > h3.para-heading:nth-of-type(n+2),
               {{WRAPPER}} .drupal_layoutbuilder-item > .para-description,
               {{WRAPPER}} .drupal_layoutbuilder-item > .drupal_layoutbuilder-item-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body,
                    {{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body h3,
                    {{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body .para-description' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body,
                        {{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body h3.para-heading,
                       {{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-body .para-description',
            ]
        );
        ...
        $this->add_control(
            'image_size_height',
            [
                'label' => ___layoutbridge_adapter('Image Size Height', 'elementor'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-image img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'image_size_width',
            [
                'label' => ___layoutbridge_adapter('Image Size Width', 'elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-image img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'image_position',
            [
                'label' => ___layoutbridge_adapter('Image Position', 'elementor'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'image_border',
                'selector' => '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-image img',
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .drupal_layoutbuilder-item .drupal_layoutbuilder-item-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if (!$content_type) {
            echo "<div class='drupal_layoutbuilder-alert'>Please select a content type.</div>";
            return;
        }
        ...
        if (empty($nids)) {
            echo "<div class='drupal_layoutbuilder-alert'>No content found.</div>";
            return;
        }
        ...
        // Wrapper
        if ($style === 'list') {
            echo '<ul class="drupal_layoutbuilder-drupal-content drupal_layoutbuilder-style-list">';
        } else {
            echo '<div class="drupal_layoutbuilder-drupal-content drupal_layoutbuilder-style-grid" style="display: grid; grid-template-columns: repeat(' . $node_columns_items . ', 1fr); gap: 20px;">';
        }

        foreach ($nodes as $node) {
            echo $style === 'list' ? '<li class="drupal_layoutbuilder-item">' : '<div class="drupal_layoutbuilder-item">';
            ...
            if (in_array($image_position, ['left_title', 'right_title'])) {
                echo '<div class="drupal_layoutbuilder-flex drupal_layoutbuilder-flex-title">';
                if ($image_position === 'left_title') {
                    echo $this->renderImageWrapper($node, $field_image);
                }
                if ($field_title && $node->hasField($field_title)) {
                    echo '<h3 class="drupal_layoutbuilder-item-title">' . $this->renderFieldValue($node->get($field_title)) . '</h3>';
                }
            ...
            if ($field_body && $node->hasField($field_body)) {
                ...
                if (in_array($image_position, ['left_body', 'right_body'])) {
                    echo '<div class="drupal_layoutbuilder-flex drupal_layoutbuilder-flex-body">';
                    if ($image_position === 'left_body') {
                        echo $this->renderImageWrapper($node, $field_image);
                    }
                    echo '<div class="drupal_layoutbuilder-item-body">' . $this->renderFieldValue($node->get($field_body)) . '</div>';
        ...
        echo '<style>
        .drupal_layoutbuilder-flex { display:flex; align-items:center; gap:10px; }
        .drupal_layoutbuilder-item-title { font-weight:bold; }
        </style>';
    }
            ...
            if (!$image_field->isEmpty()) {
                ...
                if ($entity instanceof \Drupal\media\Entity\Media && $entity->hasField('field_media_image') && !$entity->get('field_media_image')->isEmpty()) {
                    ...
                    if ($file) {
                        ...
                        return '<div class="drupal_layoutbuilder-item-image"><img src="' . $url . '" alt=""></div>';
                    }
                ...
                return "<div class='drupal_layoutbuilder-alert'>Selected field is not an image.</div>";
            }
            return "<div class='drupal_layoutbuilder-alert'>Image is not present</div>";
        }
        return '';
    }
