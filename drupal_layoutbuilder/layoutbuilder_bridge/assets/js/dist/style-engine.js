...
const aspectRatio = {
 ...
 const dimensions = ([minHeight, aspectRatio]);
;
...
const backgroundAttachment = {
 ...
 const styles_background = ([backgroundImage, backgroundPosition, backgroundRepeat, backgroundSize, backgroundAttachment]);
;
const shadow = {
  name: 'shadow',
  generate: (style, options) => {
...
const writingMode = {
 ...
 const typography = ([fontFamily, fontSize, fontStyle, fontWeight, letterSpacing, lineHeight, textColumns, textDecoration, textTransform, writingMode]);
;
