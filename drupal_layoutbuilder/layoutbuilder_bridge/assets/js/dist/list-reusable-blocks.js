...
function ImportForm({
  ...
  return (0,external_ReactJSXRuntime_namespaceObject.jsxs)("form", {
    className: "list-reusable-blocks-import-form",
    onSubmit: onSubmit,
    ref: formRef,
    children: [error && (0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Notice, {
      status: "error",
...
function ImportDropdown({
  ...
  return (0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Dropdown, {
    ...
    renderContent: ({
      onClose
    }) => (0,external_ReactJSXRuntime_namespaceObject.jsx)(import_form, {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (0,external_wp_element_namespaceObject.createRoot)(container).render((0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_element_namespaceObject.StrictMode, {
    children: (0,external_ReactJSXRuntime_namespaceObject.jsx)(import_dropdown, {
      onUpload: showNotice
    })
  }));
});
