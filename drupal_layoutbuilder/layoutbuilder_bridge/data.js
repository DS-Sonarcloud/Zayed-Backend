...
var ElementorConfig = {
  ...
  "settings": {
    "page": {
      ...
      "cssWrapperSelector": "body.drupal_layoutbuilder-page-1",
      "controls": {
        "document_settings": {
        ...
        "deploy": {
          ...
          "section": "document_settings",
          "selectors": {
            "{{WRAPPER}} h1.entry-title, .drupal_layoutbuilder-page-title": "display: none"
          },
          "name": "deploy",
          "default": "no"
        },
        "hide_title": {
          "label": "Hide Title",
          "description": "XYZ Not working? You can set a different selector for the title in the <a href=\"http://localhost/wordpress/wp-admin/admin.php?page=elementor#tab-style\" target=\"_blank\">Settings page</a>.",
          "show_label": true,
          "label_block": false,
          "separator": "default",
          "label_off": "No",
        ...
        "background_background": {
          ...
          "render_type": "ui",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-background",
        ...
        "background_color": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-color",
        ...
        "background_color_stop": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-color_stop",
        ...
        "background_color_b": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-color_b",
        ...
        "background_color_b_stop": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-color_b_stop",
        ...
        "background_gradient_type": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-gradient_type",
        ...
        "background_gradient_angle": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-gradient_angle",
        ...
        "background_gradient_position": {
          ...
          "of_type": "gradient",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-gradient_position",
        ...
        "background_image": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-image",
        ...
        "background_position": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-position",
        ...
        "background_attachment": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-attachment",
        ...
        "background_attachment_alert": {
          ...
          "content_classes": "drupal_layoutbuilder-control-field-description",
          "features": [
            "ui"
          ],
          "type": "raw_html",
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-attachment_alert",
        ...
        "background_repeat": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-repeat",
        ...
        "background_size": {
          ...
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-size",
        ...
        "background_video_link": {
          ...
          "of_type": "video",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-video_link",
        ...
        "background_video_start": {
          ...
          "of_type": "video",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-video_start",
        ...
        "background_video_end": {
          ...
          "of_type": "video",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-video_end",
        ...
        "background_video_fallback": {
          ...
          "of_type": "video",
          "classes": "drupal_layoutbuilder-group-control-background drupal_layoutbuilder-group-control drupal_layoutbuilder-group-control-video_fallback",
        ...
        "custom_css_pro": {
          ...
          "label_block": false,
          "separator": "default",
          "raw": "<div class=\"drupal_layoutbuilder-panel-nerd-box\"><i class=\"drupal_layoutbuilder-panel-nerd-box-icon eicon-hypster\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t<div class=\"drupal_layoutbuilder-panel-nerd-box-title\">Meet Our Custom CSS</div>\n\t\t\t\t\t\t<div class=\"drupal_layoutbuilder-panel-nerd-box-message\">Custom CSS lets you add CSS code to any widget, and see it render live right in the editor.</div>\n\t\t\t\t\t\t<div class=\"drupal_layoutbuilder-panel-nerd-box-message\">This feature is only available on Elementor Pro.</div>\n\t\t\t\t\t\t<a class=\"drupal_layoutbuilder-panel-nerd-box-link drupal_layoutbuilder-button drupal_layoutbuilder-button-default drupal_layoutbuilder-go-pro\" href=\"https://elementor.com/pro/?utm_source=panel-custom-css&utm_campaign=gopro&utm_medium=wp-dash&utm_term=twentyseventeen\" target=\"_blank\">Go Pro</a>\n\t\t\t\t\t\t</div>",
          "content_classes": "",
          "features": [
            "ui"
          ],
    ...
    "general": {
      ...
      "panelPage": {
        ...
        "menu": {
          "icon": "fa fa-cogs",
          "beforeItem": "drupal_layoutbuilder-settings"
        }
      },
      "cssWrapperSelector": "",
      "controls": {
        ...
        "elementor_container_width": {
          ...
          "section": "style",
          "selectors": {
            ".drupal_layoutbuilder-section.drupal_layoutbuilder-section-boxed > .drupal_layoutbuilder-container": "max-width: {{VALUE}}px"
          },
        ...
        "elementor_space_between_widgets": {
          ...
          "section": "style",
          "selectors": {
            ".drupal_layoutbuilder-widget:not(:last-child)": "margin-bottom: {{VALUE}}px"
          },
        ...
        "elementor_lightbox_color": {
          ...
          "section": "lightbox",
          "selectors": {
            ".drupal_layoutbuilder-lightbox": "background-color: {{VALUE}}"
          },
        ...
        "elementor_lightbox_ui_color": {
          ...
          "section": "lightbox",
          "selectors": {
            ".drupal_layoutbuilder-lightbox .dialog-lightbox-close-button, .drupal_layoutbuilder-lightbox .drupal_layoutbuilder-swiper-button": "color: {{VALUE}}"
          },
        ...
        "elementor_lightbox_ui_color_hover": {
          ...
          "section": "lightbox",
          "selectors": {
            ".drupal_layoutbuilder-lightbox .dialog-lightbox-close-button:hover, .drupal_layoutbuilder-lightbox .drupal_layoutbuilder-swiper-button:hover": "color: {{VALUE}}"
          },
  ...
  "wp_editor": "<div id=\"wp-elementorwpeditor-wrap\" class=\"wp-core-ui wp-editor-wrap tmce-active\"><div id=\"wp-elementorwpeditor-editor-tools\" class=\"wp-editor-tools hide-if-no-js\"><div class=\"wp-editor-tabs\"><button type=\"button\" id=\"elementorwpeditor-tmce\" class=\"wp-switch-editor switch-tmce\" data-wp-editor-id=\"elementorwpeditor\">Visual</button>\n<button type=\"button\" id=\"elementorwpeditor-html\" class=\"wp-switch-editor switch-html\" data-wp-editor-id=\"elementorwpeditor\">Text</button>\n</div>\n</div>\n<div id=\"wp-elementorwpeditor-editor-container\" class=\"wp-editor-container\"><div id=\"qt_elementorwpeditor_toolbar\" class=\"quicktags-toolbar\"></div><textarea class=\"drupal_layoutbuilder-wp-editor wp-editor-area\" style=\"height: 250px\" autocomplete=\"off\" cols=\"40\" name=\"elementorwpeditor\" id=\"elementorwpeditor\">%%EDITORCONTENT%%</textarea></div>\n</div>\n\n",
  "settings_page_link": "",
